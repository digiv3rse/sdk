...
export type GenerateDiGiApiRelayAddressQueryVariables = Types.Exact<{ [key: string]: never }>;

export type GenerateDiGiApiRelayAddressQuery = { result: string };

export type DiGiTransactionStatusQueryVariables = Types.Exact<{
  request: Types.DiGiTransactionStatusRequest;
}>;

export type DiGiTransactionStatusQuery = { result: DiGiTransactionResultFragment | null };
...
export const DiGiTransactionResultFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'DiGiTransactionResult' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'DiGiTransactionResult' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
...
export const GenerateDiGiApiRelayAddressDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GenerateDiGiAPIRelayAddress' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'DiGiTransactionStatus' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'DiGiTransactionStatusRequest' },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'FragmentSpread', name: { kind: 'Name', value: 'DiGiTransactionResult' } },
              ],
            },
          },
        ],
...
const GenerateDiGiApiRelayAddressDocumentString = print(GenerateDiGiApiRelayAddressDocument);
const DiGiTransactionStatusDocumentString = print(DiGiTransactionStatusDocument);
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    GenerateDiGiAPIRelayAddress(
      variables?: GenerateDiGiApiRelayAddressQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<{
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<GenerateDiGiApiRelayAddressQuery>(
            GenerateDiGiApiRelayAddressDocumentString,
            variables,
    ...
    DiGiTransactionStatus(
      variables: DiGiTransactionStatusQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<{
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<DiGiTransactionStatusQuery>(
            DiGiTransactionStatusDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'DiGiTransactionStatus',
