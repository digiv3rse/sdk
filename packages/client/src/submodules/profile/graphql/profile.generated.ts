...
export type ProfileManagerFragment = { address: string; isDiGiManager: boolean };
...
export type BlockMutation = { result: DiGiProfileManagerRelayErrorFragment | RelaySuccessFragment };
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'isDiGiManager' } },
        ],
      },
    },
  ],
            ...
            selectionSet: {
              ...
              selections: [
                ...
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'DiGiProfileManagerRelayError' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'FollowDiGiManagerRequest' } },
          },
        },
      ],
      selectionSet: {
