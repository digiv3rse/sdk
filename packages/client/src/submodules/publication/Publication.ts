import { hasAtLeastOne, never, PromiseResult, success } from '@digiv3rse/shared-kernel';
...
export class Publication {
  ...
  async postOnMomoka(
    ...
    CreateMomokaPublicationResultFragment | DiGiProfileManagerRelayErrorFragment,
    CredentialsExpiredError | NotAuthenticatedError
  > {
    return requireAuthHeaders(this.authentication, async (headers) => {
