...
import type { PaginatedResult } from "../helpers/buildPaginatedQueryResult.js";
import type { ApprovedAuthenticationFragment, AuthChallengeFragment } from "./graphql/auth.generated.js";
/**
 * Authentication for DiGi API.
 *
...
export interface IAuthentication {
     ...
     *
     * ⚠️ Requires authenticated DiGiClient with wallet only.
     *
     * @example
     * ```ts
     ...
     * ```
     */
    upgradeCredentials(request: WalletAuthenticationToProfileAuthenticationRequest): PromiseResult<void, CredentialsExpiredError | NotAuthenticatedError>;
    /**
     ...
     * ```
     */
    fetch(): PromiseResult<ApprovedAuthenticationFragment, CredentialsExpiredError | NotAuthenticatedError>;
    /**
     ...
     * ```
     */
    fetchAll(request?: ApprovedAuthenticationRequest): PromiseResult<PaginatedResult<ApprovedAuthenticationFragment>, CredentialsExpiredError | NotAuthenticatedError>;
    /**
     ...
     * ```
     */
    revoke(request: RevokeAuthenticationRequest): PromiseResult<void, CredentialsExpiredError | NotAuthenticatedError>;
}
