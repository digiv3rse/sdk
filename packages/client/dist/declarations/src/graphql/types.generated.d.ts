import type { ImageSizeTransform } from "./ImageSizeTransform.js";
...
export type Scalars = {
    ...
    ImageSizeTransform: {
        input: ImageSizeTransform;
        output: ImageSizeTransform;
    };
    Jwt: {
        input: string;
        output: string;
...
/** The digi manager will only support follow modules which are verified here - https://github.com/digi-protocol/verified-modules/blob/master/follow-modules.json */
...
export declare enum RelayRoleKey {
    ...
    DiGiManager_21 = "DIGI_MANAGER_21",
    DiGiManager_22 = "DIGI_MANAGER_22",
    DiGiManager_23 = "DIGI_MANAGER_23",
    DiGiManager_24 = "DIGI_MANAGER_24",
    DiGiManager_25 = "DIGI_MANAGER_25",
    DiGiManager_26 = "DIGI_MANAGER_26",
    DiGiManager_27 = "DIGI_MANAGER_27",
    DiGiManager_28 = "DIGI_MANAGER_28",
    DiGiManager_29 = "DIGI_MANAGER_29",
    DiGiManager_30 = "DIGI_MANAGER_30",
