import { Erc20Amount, EvmAddress } from '@digiv3rse/shared-kernel';
export declare enum FollowPolicyType {
    CHARGE = "CHARGE",
    ANYONE = "ANYONE",
    NO_ONE = "NO_ONE",
    UNKNOWN = "UNKNOWN"
 ...
 */
export type FollowPolicyConfig = ChargeFollowConfig | NoFollowConfig | OpenFollowConfig | UnknownFollowConfig;
