...
var TokenAllowance = require('../../../dist/TokenAllowance-b2c19a5c.cjs.prod.js');
...
var unsupportedIterableToArray = require('../../../dist/unsupportedIterableToArray-afbea1dd.cjs.prod.js');
var sharedKernel = require('@digiv3rse/shared-kernel');
var Transactions = require('../../../dist/Transactions-944d0a48.cjs.prod.js');
require('../../../dist/inherits-21b1f04d.cjs.prod.js');
require('../../../dist/wrapNativeSuper-40eed49e.cjs.prod.js');
...
var DelegableSigning = /*#__PURE__*/function () {
  function DelegableSigning(signedOperation, transactionGateway, transactionQueue, presenter) {
    createClass._classCallCheck(this, DelegableSigning);
    this.signedOperation = signedOperation;
    this.transactionGateway = transactionGateway;
    this.transactionQueue = transactionQueue;
    this.presenter = presenter;
  }
  createClass._createClass(DelegableSigning, [{
    key: "execute",
    value: function () {
...
var SubsidizeOffChain = /*#__PURE__*/function () {
  function SubsidizeOffChain(activeWallet, gateway, relayer, queue, presenter) {
    createClass._classCallCheck(this, SubsidizeOffChain);
  ...
  createClass._createClass(SubsidizeOffChain, [{
    key: "execute",
    value: function () {
      var _execute = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee(request) {
...
var SignedOnChain = /*#__PURE__*/function () {
  function SignedOnChain(activeWallet, metaTransactionNonceGateway, signedOnChainGateway, relayer, transactionQueue, presenter) {
    createClass._classCallCheck(this, SignedOnChain);
    this.activeWallet = activeWallet;
  ...
  createClass._createClass(SignedOnChain, [{
    key: "execute",
    value: function () {
      var _execute = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee(request) {
...
var TransactionQueue = /*#__PURE__*/function () {
  function TransactionQueue(responders, transactionGateway, transactionQueuePresenter) {
    createClass._classCallCheck(this, TransactionQueue);
    this.responders = responders;
    this.transactionGateway = transactionGateway;
    this.transactionQueuePresenter = transactionQueuePresenter;
  }
  createClass._createClass(TransactionQueue, [{
    key: "clearRecent",
    ...
    key: "push",
    value: function () {
      var _push = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee(transaction, presenter) {
        return asyncToGenerator._regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
    ...
    key: "resume",
    value: function () {
      var _resume = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee2() {
    ...
    key: "handle",
    value: function () {
      var _handle = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee3(transaction, presenter) {
        var txData;
    ...
    key: "observe",
    value: function () {
      var _observe = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee4(transaction, presenter) {
        ...
        return asyncToGenerator._regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 14:
              presenter === null || presenter === void 0 || presenter.present(sharedKernel.success(txData));
            case 15:
            case "end":
    ...
    key: "prepare",
    value: function () {
      var _prepare = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee5(txData) {
    ...
    key: "commit",
    value: function () {
      var _commit = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee6(txData) {
        var responder;
    ...
    key: "rollback",
    value: function () {
      var _rollback = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee7(error, txData) {
    ...
    key: "waitCompletion",
    value: function () {
      var _waitCompletion = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee8(transaction) {
        var _result;
        return asyncToGenerator._regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 6:
              if (!(_result.value === Transactions.TransactionEvent.SETTLED)) {
                _context8.next = 8;
                break;
              }
              return _context8.abrupt("return", sharedKernel.success());
            case 8:
    ...
    value: function create(responders, transactionGateway, transactionQueuePresenter) {
      ...
      transactionGateway.subscribe( /*#__PURE__*/function () {
        var _ref = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee9(newTransactions) {
...
exports.BroadcastingError = TokenAllowance.BroadcastingError;
exports.BroadcastingErrorReason = TokenAllowance.BroadcastingErrorReason;
exports.PaidTransaction = TokenAllowance.PaidTransaction;
exports.TokenAllowance = TokenAllowance.TokenAllowance;
exports.TokenAllowanceLimit = TokenAllowance.TokenAllowanceLimit;
exports.DelegableSigning = DelegableSigning;
exports.SignedOnChain = SignedOnChain;
exports.SubsidizeOffChain = SubsidizeOffChain;
