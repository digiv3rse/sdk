 ...
 * @internal
 */
export declare const failure: <E extends IEquatableError<string, string>>(error: E) => Failure<E>;
/**
 * Ensures the `Result<T, E>` is a `Success<T>`.
 */
export declare function assertSuccess<T>(result: Result<T, IEquatableError>): asserts result is Success<T>;
/**
 * Ensures the `Result<T, E>` is a `Failure<E>`.
 */
export declare function assertFailure<T, E extends IEquatableError>(result: Result<T, E>): asserts result is Failure<E>;
