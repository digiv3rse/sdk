...
import { _ as _inherits, a as _classCallCheck, b as _callSuper, c as _assertThisInitialized, d as _createClass, e as _wrapNativeSuper, i as invariant, I as InvariantError } from './Amount-a5200950.esm.js';
export { A as Amount, B as BigDecimal, C as ChainType, D as Denomination, I as InvariantError, K as Kind, N as NativeType, W as WellKnownSymbols, f as erc20, g as ether, h as fiat, i as invariant, m as matic } from './Amount-a5200950.esm.js';
...
var CausedError = /*#__PURE__*/function (_Error) {
  ...
  function CausedError(message, options) {
    ...
    _this = _callSuper(this, CausedError, [message, options]);
    if (isObject(options) && options.cause && !('cause' in _assertThisInitialized(_this))) {
...
function assertError(error) {
  ...
  if (!isObject$1(error) || !Error.prototype.isPrototypeOf(error)) {
    throw error;
  }
}
