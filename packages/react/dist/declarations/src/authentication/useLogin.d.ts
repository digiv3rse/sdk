...
import { LoginError, LoginRequest } from '@digiv3rse/domain/use-cases/authentication';
 ...
 * @group Hooks
 */
export declare function useLogin(): UseDeferredTask<Profile | null, LoginError, LoginRequest>;
