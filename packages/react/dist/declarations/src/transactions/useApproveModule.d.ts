import { AnyPublication, Profile } from '@digiv3rse/api-bindings';
...
import { TokenAllowanceLimit } from '@digiv3rse/domain/use-cases/transactions';
 ...
 * @group Hooks
 */
export declare function useApproveModule(args?: UseApproveModuleArgs): UseDeferredTask<void, InsufficientGasError | PendingSigningRequestError | TransactionError | UserRejectedError | WalletConnectionError, ApproveModuleArgs>;
