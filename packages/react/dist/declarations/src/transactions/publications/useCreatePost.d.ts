import { Post } from '@digiv3rse/api-bindings';
 ...
 * @group Hooks
 */
export declare function useCreatePost(): UseDeferredTask<PostAsyncResult, BroadcastingError | InsufficientGasError | PendingSigningRequestError | UserRejectedError | WalletConnectionError, CreatePostArgs>;
