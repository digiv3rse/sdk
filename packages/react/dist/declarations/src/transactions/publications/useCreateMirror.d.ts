import { Mirror } from '@digiv3rse/api-bindings';
 ...
 * @group Hooks
 */
export declare function useCreateMirror(): UseDeferredTask<MirrorAsyncResult, BroadcastingError | InsufficientGasError | PendingSigningRequestError | UserRejectedError | WalletConnectionError, CreateMirrorArgs>;
