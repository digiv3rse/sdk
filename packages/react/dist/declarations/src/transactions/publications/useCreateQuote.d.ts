import { Quote } from '@digiv3rse/api-bindings';
import { InsufficientGasError, PendingSigningRequestError, PublicationId, UserRejectedError, WalletConnectionError } from '@digiv3rse/domain/entities';
import { OpenActionConfig, ReferencePolicyConfig } from '@digiv3rse/domain/use-cases/publications';
 ...
 * @group Hooks
 */
export declare function useCreateQuote(): UseDeferredTask<QuoteAsyncResult, BroadcastingError | InsufficientGasError | PendingSigningRequestError | UserRejectedError | WalletConnectionError, CreateQuoteArgs>;
