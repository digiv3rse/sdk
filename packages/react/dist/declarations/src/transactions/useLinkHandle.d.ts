 ...
 *
 */
export declare function useLinkHandle(): UseDeferredTask<AsyncTransactionResult<void>, BroadcastingError | PendingSigningRequestError | UserRejectedError | WalletConnectionError | InsufficientGasError, LinkHandleArgs>;
