import { HandleInfo } from '@digiv3rse/api-bindings';
 ...
 *
 */
export declare function useUnlinkHandle(): UseDeferredTask<AsyncTransactionResult<void>, BroadcastingError | InsufficientGasError | PendingSigningRequestError | UserRejectedError | WalletConnectionError, UnlinkHandleArgs>;
