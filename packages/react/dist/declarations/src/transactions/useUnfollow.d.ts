 ...
 *
 */
export declare function useUnfollow(): UseDeferredTask<UnfollowAsyncResult, BroadcastingError | InsufficientGasError | PendingSigningRequestError | UserRejectedError | WalletConnectionError, UnfollowArgs>;
