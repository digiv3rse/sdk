...
import { AtLeastOneOf, EvmAddress } from '@digiv3rse/shared-kernel';
import { UseDeferredTask } from "../helpers/tasks.js";
export type UpdateProfileManagersArgs = AtLeastOneOf<{
    /**
     * Enables the DiGi Profile Manager to sign transactions on behalf of the authenticated Profile.
     */
 ...
 */
export declare function useUpdateProfileManagers(): UseDeferredTask<void, BroadcastingError | InsufficientGasError | PendingSigningRequestError | TransactionError | UserRejectedError | WalletConnectionError, UpdateProfileManagersArgs>;
