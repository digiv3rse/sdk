...
export type BlockOperation = UseDeferredTask<AsyncTransactionResult<void>, BroadcastingError | InsufficientAllowanceError | InsufficientFundsError | InsufficientGasError | PendingSigningRequestError | TransactionError | UserRejectedError | WalletConnectionError, BlockProfileArgs>;
/**
 ...
 *
 */
export declare function useBlockProfiles(): BlockOperation;
