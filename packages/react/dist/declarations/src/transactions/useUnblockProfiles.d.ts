...
export type UnblockOperation = UseDeferredTask<AsyncTransactionResult<void>, BroadcastingError | InsufficientAllowanceError | InsufficientFundsError | InsufficientGasError | PendingSigningRequestError | UserRejectedError | WalletConnectionError, UnblockProfileArgs>;
/**
 ...
 *
 */
export declare function useUnblockProfiles(): UnblockOperation;
