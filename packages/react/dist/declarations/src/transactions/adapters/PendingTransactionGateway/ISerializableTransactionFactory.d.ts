import { DataTransaction, MetaTransaction, NativeTransaction } from '@digiv3rse/domain/entities';
import { ProtocolTransactionRequest, AnyTransactionRequest } from '@digiv3rse/domain/use-cases/transactions';
