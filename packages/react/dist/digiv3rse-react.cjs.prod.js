...
var authentication = require('@digiv3rse/domain/use-cases/authentication');
var gql = require('@digiv3rse/api-bindings');
var entities = require('@digiv3rse/domain/entities');
var transactions = require('@digiv3rse/domain/use-cases/transactions');
var wallets = require('@digiv3rse/domain/use-cases/wallets');
      ...
      var _refreshToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              sharedKernel.invariant(this.isRefreshing === false, 'Cannot refresh token while refreshing');
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              return _context2.abrupt("return", sharedKernel.failure(new authentication.CredentialsExpiredError()));
            case 5:
              _context2.prev = 5;
              _context2.next = 8;
            ...
            case 11:
              return _context2.abrupt("return", sharedKernel.success());
            case 14:
              _context2.prev = 14;
      ...
      var _onTokenExpired = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.logout.execute(authentication.LogoutReason.CREDENTIALS_EXPIRED);
            case 2:
            case "end":
              return _context.stop();
          }
...
var CredentialsStorage = /*#__PURE__*/function () {
  function CredentialsStorage(storageProvider, namespace) {
    ...
    var authStorageSchema = new storage.CredentialsStorageSchema("digi.".concat(namespace, ".credentials"));
    this.refreshTokenStorage = storage.Storage.createForSchema(authStorageSchema, storageProvider);
  }
...
function createInboxKeyStorage(storageProvider, namespace) {
  var notificationStorageDataSchema = new storage.BaseStorageSchema("digi.".concat(namespace, ".inbox.keyBundle"), KeyBundleData);
      ...
      var _refreshCurrentProfile = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 3:
              sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, "It's not possible to refresh a profile without a profile session");
              _context3.next = 6;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              sharedKernel.invariant(gql.isPostPublication(publication), "Unexpected publication type");
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              sharedKernel.invariant(gql.isCommentPublication(publication), "Unexpected publication type");
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              sharedKernel.invariant(gql.isMirrorPublication(publication), "Unexpected publication type");
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              sharedKernel.invariant(gql.isQuotePublication(publication), "Unexpected publication type");
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              sharedKernel.invariant(publication, "Publication for ".concat((_request$forId = request.forId) !== null && _request$forId !== void 0 ? _request$forId : request.forTxHash, " not found"));
...
function handleRelayError(error, _) {
  switch (error.reason) {
    case gql.RelayErrorReasonType.AppNotAllowed:
    case gql.DiGiProfileManagerRelayErrorReasonType.AppNotAllowed:
      return sharedKernel.failure(new transactions.BroadcastingError(transactions.BroadcastingErrorReason.APP_NOT_ALLOWED, {
        details: 'See https://docs.digiv3rse.xyz/docs/gasless-and-signless#whitelisting-your-app'
      }));
    case gql.RelayErrorReasonType.RateLimited:
    case gql.DiGiProfileManagerRelayErrorReasonType.RateLimited:
      return sharedKernel.failure(new transactions.BroadcastingError(transactions.BroadcastingErrorReason.RATE_LIMITED));
    case gql.RelayErrorReasonType.NotSponsored:
    case gql.DiGiProfileManagerRelayErrorReasonType.NotSponsored:
      return sharedKernel.failure(new transactions.BroadcastingError(transactions.BroadcastingErrorReason.NOT_SPONSORED));
    case gql.RelayErrorReasonType.Failed:
    case gql.DiGiProfileManagerRelayErrorReasonType.Failed:
      return sharedKernel.failure(new transactions.BroadcastingError(transactions.BroadcastingErrorReason.UNKNOWN));
    case gql.DiGiProfileManagerRelayErrorReasonType.NoDiGiManagerEnabled:
      return sharedKernel.failure(new transactions.BroadcastingError(transactions.BroadcastingErrorReason.NO_DIGI_MANAGER_ENABLED));
    case gql.DiGiProfileManagerRelayErrorReasonType.RequiresSignature:
      return sharedKernel.failure(new transactions.BroadcastingError(transactions.BroadcastingErrorReason.REQUIRES_SIGNATURE));
    default:
      throw new sharedKernel.InvariantError("Unexpected relay error reason: ".concat(error.reason));
  }
}
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              return _context.abrupt("return", sharedKernel.success(transaction));
            case 8:
            case "end":
              return _context.stop();
          }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.BroadcastOnMomokaDocument,
                variables: {
                  request: {
                    id: signedCall.id,
            ...
            case 7:
              return _context2.abrupt("return", sharedKernel.success(data.result));
            case 10:
              _context2.prev = 10;
              ...
              return _context2.abrupt("return", sharedKernel.failure(new transactions.BroadcastingError(transactions.BroadcastingErrorReason.UNKNOWN, {
                cause: _context2.t0
              })));
            case 15:
            case "end":
...
var UriSchema = zod.z.string().min(6).url().transform(uri);
var EvmAddressSchema = zod.z.string().min(42).transform(function (value) {
  return value;
});
var DataSchema = zod.z.string().transform(data);
var ProfileIdSchema = zod.z.string().transform(profileId);
var PublicationIdSchema = zod.z.string().transform(publicationId);
var SerializedErc20Schema = zod.z.object({
  kind: zod.z.literal(sharedKernel.Kind.ERC20),
  name: zod.z.string(),
  decimals: zod.z.number(),
  symbol: zod.z.string(),
  address: zod.z.string(),
  chainType: zod.z.nativeEnum(sharedKernel.ChainType)
});
var SerializedErc20AmountSchema = zod.z.object({
  asset: SerializedErc20Schema,
  value: zod.z.string()
});
// Checky workaround to private constructor
var AmountCtor = sharedKernel.Amount.ether(0).constructor;
var Erc20AmountSchema = zod.z.union([SerializedErc20AmountSchema, zod.z["instanceof"](AmountCtor)]).superRefine(function (val, ctx) {
  ...
  return value instanceof AmountCtor ? value : sharedKernel.Amount.erc20(sharedKernel.erc20(value.asset), value.value);
});

var TokenAllowanceRequestSchema = zod.z.object({
  amount: Erc20AmountSchema,
  spender: zod.z.string(),
  limit: zod.z.nativeEnum(transactions.TokenAllowanceLimit),
  kind: zod.z.literal(entities.TransactionKind.APPROVE_MODULE)
});

var CreateProfileRequestSchema = zod.z.object({
  kind: zod.z.literal(entities.TransactionKind.CREATE_PROFILE),
  localName: zod.z.string(),
  approveSignless: zod.z["boolean"](),
  to: EvmAddressSchema
});
var FollowRequestFeeSchema = zod.z.object({
  amount: Erc20AmountSchema,
  contractAddress: zod.z.string(),
  recipient: zod.z.string()
});
var FreeFollowRequestSchema = zod.z.object({
  profileId: ProfileIdSchema,
  kind: zod.z.literal(entities.TransactionKind.FOLLOW_PROFILE),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});
var PaidFollowRequestSchema = zod.z.object({
  profileId: ProfileIdSchema,
  kind: zod.z.literal(entities.TransactionKind.FOLLOW_PROFILE),
  fee: FollowRequestFeeSchema,
  signless: zod.z.literal(false),
  sponsored: zod.z["boolean"]()
});
var UnknownFollowRequestSchema = zod.z.object({
  profileId: ProfileIdSchema,
  kind: zod.z.literal(entities.TransactionKind.FOLLOW_PROFILE),
...
var FollowRequestSchema = zod.z.union([PaidFollowRequestSchema, FreeFollowRequestSchema, UnknownFollowRequestSchema]);
var UnfollowRequestSchema = zod.z.object({
  profileId: ProfileIdSchema,
  kind: zod.z.literal(entities.TransactionKind.UNFOLLOW_PROFILE),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});
var UpdateProfileManagersRequestSchema = zod.z.object({
  approveSignless: zod.z["boolean"]().optional(),
  add: EvmAddressSchema.array().min(1).optional(),
  remove: EvmAddressSchema.array().min(1).optional(),
  kind: zod.z.literal(entities.TransactionKind.UPDATE_PROFILE_MANAGERS),
  sponsored: zod.z["boolean"]()
...
var ChargeFollowPolicyConfigSchema = zod.z.object({
  type: zod.z.literal(profile.FollowPolicyType.CHARGE),
  amount: Erc20AmountSchema,
  recipient: zod.z.string()
});
var AnyoneFollowPolicyConfigSchema = zod.z.object({
  type: zod.z.literal(profile.FollowPolicyType.ANYONE)
});
var NoOneFollowPolicyConfigSchema = zod.z.object({
  type: zod.z.literal(profile.FollowPolicyType.NO_ONE)
});
var UnknownFollowPolicyConfigSchema = zod.z.object({
  type: zod.z.literal(profile.FollowPolicyType.UNKNOWN),
  address: EvmAddressSchema,
  data: DataSchema
});
var FollowPolicyConfigSchema = zod.z.discriminatedUnion('type', [ChargeFollowPolicyConfigSchema, AnyoneFollowPolicyConfigSchema, NoOneFollowPolicyConfigSchema, UnknownFollowPolicyConfigSchema]);
var UpdateFollowPolicyRequestSchema = zod.z.object({
  policy: FollowPolicyConfigSchema,
  kind: zod.z.literal(entities.TransactionKind.UPDATE_FOLLOW_POLICY),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});
var SetProfileMetadataRequestSchema = zod.z.object({
  metadataURI: UriSchema,
  kind: zod.z.literal(entities.TransactionKind.UPDATE_PROFILE_DETAILS),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});
var LinkHandleRequestSchema = zod.z.object({
  fullHandle: zod.z.string(),
  profileId: ProfileIdSchema,
  kind: zod.z.literal(entities.TransactionKind.LINK_HANDLE),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});
var UnlinkHandleRequestSchema = zod.z.object({
  fullHandle: zod.z.string(),
  profileId: ProfileIdSchema,
  kind: zod.z.literal(entities.TransactionKind.UNLINK_HANDLE),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});
var UnblockProfilesRequestSchema = zod.z.object({
  profileIds: ProfileIdSchema.array().min(1),
  kind: zod.z.literal(entities.TransactionKind.UNBLOCK_PROFILE),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});
var ClaimHandleRequestSchema = zod.z.union([zod.z.object({
  kind: zod.z.literal(entities.TransactionKind.CLAIM_HANDLE),
  localName: zod.z.string(),
...
var BlockProfilesRequestSchema = zod.z.object({
  profileIds: ProfileIdSchema.array().min(1),
  kind: zod.z.literal(entities.TransactionKind.BLOCK_PROFILE),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});

var RecipientWithSplitSchema = zod.z.object({
  recipient: EvmAddressSchema,
  split: zod.z.number()
});
var SimpleCollectActionConfigSchema = zod.z.object({
  type: zod.z.literal(publications.OpenActionType.SIMPLE_COLLECT),
  amount: Erc20AmountSchema.optional(),
  followerOnly: zod.z["boolean"](),
  referralFee: zod.z.number().optional(),
  collectLimit: zod.z.number().optional(),
  recipient: EvmAddressSchema.optional(),
  endsAt: zod.z.coerce.date().min(new Date()).optional()
});
var MultirecipientCollectActionConfigSchema = zod.z.object({
  type: zod.z.literal(publications.OpenActionType.MULTIRECIPIENT_COLLECT),
  amount: Erc20AmountSchema,
  followerOnly: zod.z["boolean"](),
  referralFee: zod.z.number().optional(),
  collectLimit: zod.z.number().optional(),
  recipients: zod.z.array(RecipientWithSplitSchema),
  endsAt: zod.z.coerce.date().min(new Date()).optional()
});
var UnknownOpenActionConfigSchema = zod.z.object({
  type: zod.z.literal(publications.OpenActionType.UNKNOWN_OPEN_ACTION),
  address: EvmAddressSchema,
  data: DataSchema
});
var OpenActionConfigSchema = zod.z.discriminatedUnion('type', [SimpleCollectActionConfigSchema, MultirecipientCollectActionConfigSchema, UnknownOpenActionConfigSchema]).superRefine(function (val, ctx) {
  if (val.type === publications.OpenActionType.SIMPLE_COLLECT) {
...
var AnyoneReferencePolicyConfigSchema = zod.z.object({
  type: zod.z.literal(publications.ReferencePolicyType.ANYONE)
});
var DegreesOfSeparationReferencePolicyConfigSchema = zod.z.object({
  type: zod.z.literal(publications.ReferencePolicyType.DEGREES_OF_SEPARATION),
  params: zod.z.object({
    commentsRestricted: zod.z["boolean"](),
    mirrorsRestricted: zod.z["boolean"](),
    degreesOfSeparation: zod.z.number(),
    quotesRestricted: zod.z["boolean"](),
    sourceProfileId: ProfileIdSchema.optional()
  })
});
var FollowersOnlyReferencePolicyConfigSchema = zod.z.object({
  type: zod.z.literal(publications.ReferencePolicyType.FOLLOWERS_ONLY)
});
var NoReferencePolicyConfigSchema = zod.z.object({
  type: zod.z.literal(publications.ReferencePolicyType.NO_ONE)
});
var ReferencePolicyConfigSchema = zod.z.discriminatedUnion('type', [AnyoneReferencePolicyConfigSchema, DegreesOfSeparationReferencePolicyConfigSchema, FollowersOnlyReferencePolicyConfigSchema, NoReferencePolicyConfigSchema]);
var CreatePostRequestSchema = zod.z.object({
  kind: zod.z.literal(entities.TransactionKind.CREATE_POST),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"](),
  metadata: UriSchema,
...
var CreateCommentRequestSchema = zod.z.object({
  kind: zod.z.literal(entities.TransactionKind.CREATE_COMMENT),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"](),
  metadata: UriSchema,
...
var CreateQuoteRequestSchema = zod.z.object({
  kind: zod.z.literal(entities.TransactionKind.CREATE_QUOTE),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"](),
  metadata: UriSchema,
...
var CreateMirrorRequestSchema = zod.z.object({
  mirrorOn: PublicationIdSchema,
  kind: zod.z.literal(entities.TransactionKind.MIRROR_PUBLICATION),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});
var CollectFeeSchema = zod.z.object({
  amount: Erc20AmountSchema,
  contractAddress: EvmAddressSchema
});
var BaseCollectRequestSchema = zod.z.object({
  kind: zod.z.literal(entities.TransactionKind.ACT_ON_PUBLICATION),
  publicationId: PublicationIdSchema
});
var LegacyCollectRequestSchema = BaseCollectRequestSchema.extend({
  type: zod.z.literal(publications.AllOpenActionType.LEGACY_COLLECT),
  publicationId: PublicationIdSchema,
  referrer: PublicationIdSchema.optional(),
  fee: CollectFeeSchema.optional(),
  "public": zod.z.literal(false),
  signless: zod.z["boolean"](),
  sponsored: zod.z["boolean"]()
});
var SimpleCollectRequestSchema = BaseCollectRequestSchema.extend({
  type: zod.z.literal(publications.AllOpenActionType.SIMPLE_COLLECT),
  publicationId: PublicationIdSchema,
  referrers: zod.z.union([PublicationIdSchema, ProfileIdSchema]).array().min(1).optional(),
  fee: CollectFeeSchema.optional(),
...
var MultirecipientCollectRequestSchema = BaseCollectRequestSchema.extend({
  type: zod.z.literal(publications.AllOpenActionType.MULTIRECIPIENT_COLLECT),
  publicationId: PublicationIdSchema,
  referrers: zod.z.union([PublicationIdSchema, ProfileIdSchema]).array().min(1).optional(),
...
var UnknownActionRequestSchema = BaseCollectRequestSchema.extend({
  type: zod.z.literal(publications.AllOpenActionType.UNKNOWN_OPEN_ACTION),
  publicationId: PublicationIdSchema,
  address: EvmAddressSchema,
  data: DataSchema,
  referrers: zod.z.union([PublicationIdSchema, ProfileIdSchema]).array().min(1).optional(),
...
var OpenActionRequestSchema = zod.z.discriminatedUnion('type', [LegacyCollectRequestSchema, SimpleCollectRequestSchema, MultirecipientCollectRequestSchema, UnknownActionRequestSchema]);

/* eslint-disable no-fallthrough */
function resolveProtocolTransactionRequestSchema(kind) {
  switch (kind) {
    case entities.TransactionKind.ACT_ON_PUBLICATION:
      return OpenActionRequestSchema;
    case entities.TransactionKind.BLOCK_PROFILE:
      return BlockProfilesRequestSchema;
    case entities.TransactionKind.CLAIM_HANDLE:
      return ClaimHandleRequestSchema;
    case entities.TransactionKind.CREATE_COMMENT:
      return CreateCommentRequestSchema;
    case entities.TransactionKind.CREATE_POST:
      return CreatePostRequestSchema;
    case entities.TransactionKind.CREATE_PROFILE:
      return CreateProfileRequestSchema;
    case entities.TransactionKind.CREATE_QUOTE:
      return CreateQuoteRequestSchema;
    case entities.TransactionKind.FOLLOW_PROFILE:
      return FollowRequestSchema;
    case entities.TransactionKind.LINK_HANDLE:
      return LinkHandleRequestSchema;
    case entities.TransactionKind.MIRROR_PUBLICATION:
      return CreateMirrorRequestSchema;
    case entities.TransactionKind.UNFOLLOW_PROFILE:
      return UnfollowRequestSchema;
    case entities.TransactionKind.UNLINK_HANDLE:
      return UnlinkHandleRequestSchema;
    case entities.TransactionKind.UPDATE_FOLLOW_POLICY:
      return UpdateFollowPolicyRequestSchema;
    case entities.TransactionKind.UPDATE_PROFILE_DETAILS:
      return SetProfileMetadataRequestSchema;
    case entities.TransactionKind.UPDATE_PROFILE_MANAGERS:
      return UpdateProfileManagersRequestSchema;
    case entities.TransactionKind.UNBLOCK_PROFILE:
...
function resolveAnyTransactionRequestSchema(kind) {
  switch (kind) {
    case entities.TransactionKind.APPROVE_MODULE:
...
var ProtocolTransactionRequestSchema = zod.z.object({
  kind: zod.z["enum"](entities.ProtocolTransactionKinds)
...
var AnyTransactionRequestSchema = zod.z.object({
  kind: zod.z.nativeEnum(entities.TransactionKind)
...
var MetaTransactionSchema = zod.z.object({
  type: zod.z.literal(TransactionType.Meta),
  chainType: zod.z.nativeEnum(sharedKernel.ChainType),
  id: zod.z.string(),
  relayerTxId: zod.z.string(),
  txHash: zod.z.string().nullable(),
  nonce: zod.z.number(),
  request: ProtocolTransactionRequestSchema
});
var NativeTransactionSchema = zod.z.object({
  type: zod.z.literal(TransactionType.Native),
  chainType: zod.z.nativeEnum(sharedKernel.ChainType),
  id: zod.z.string(),
  relayerTxId: zod.z.string().optional(),
  txHash: zod.z.string().nullable(),
  request: AnyTransactionRequestSchema
});
var DataTransactionSchema = zod.z.object({
  type: zod.z.literal(TransactionType.Data),
  id: zod.z.string(),
  request: ProtocolTransactionRequestSchema
});
var TransactionSchema = zod.z.discriminatedUnion('type', [MetaTransactionSchema, NativeTransactionSchema, DataTransactionSchema]);
var TransactionListSchema = zod.z.array(TransactionSchema);

var _transactionKindToFil;
var digiHubTransactionKinds = [entities.TransactionKind.ACT_ON_PUBLICATION, entities.TransactionKind.CREATE_COMMENT, entities.TransactionKind.CREATE_POST, entities.TransactionKind.CREATE_QUOTE, entities.TransactionKind.FOLLOW_PROFILE, entities.TransactionKind.MIRROR_PUBLICATION, entities.TransactionKind.UPDATE_PROFILE_MANAGERS, entities.TransactionKind.UPDATE_FOLLOW_POLICY, entities.TransactionKind.UPDATE_PROFILE_DETAILS];

// const tokenHandleRegistryTransactionKinds = []; // not used yet

var transactionKindToFilterGroup = (_transactionKindToFil = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_transactionKindToFil, entities.TransactionKind.ACT_ON_PUBLICATION, digiHubTransactionKinds), entities.TransactionKind.BLOCK_PROFILE, digiHubTransactionKinds), entities.TransactionKind.UNBLOCK_PROFILE, digiHubTransactionKinds), entities.TransactionKind.CREATE_COMMENT, digiHubTransactionKinds), entities.TransactionKind.CREATE_POST, digiHubTransactionKinds), entities.TransactionKind.CREATE_QUOTE, digiHubTransactionKinds), entities.TransactionKind.FOLLOW_PROFILE, digiHubTransactionKinds), entities.TransactionKind.MIRROR_PUBLICATION, digiHubTransactionKinds), entities.TransactionKind.UPDATE_PROFILE_MANAGERS, digiHubTransactionKinds), entities.TransactionKind.UPDATE_FOLLOW_POLICY, digiHubTransactionKinds), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_transactionKindToFil, entities.TransactionKind.UPDATE_PROFILE_DETAILS, digiHubTransactionKinds), entities.TransactionKind.CLAIM_HANDLE, []), entities.TransactionKind.APPROVE_MODULE, []), entities.TransactionKind.CREATE_PROFILE, []), entities.TransactionKind.UNFOLLOW_PROFILE, []), entities.TransactionKind.LINK_HANDLE, []), entities.TransactionKind.UNLINK_HANDLE, []));
function isSerializableMetaTransaction(tx) {
  return tx instanceof entities.MetaTransaction;
}
function toTransactionSchema(tx) {
  if (tx instanceof entities.MetaTransaction) {
    return _objectSpread2({
      type: TransactionType.Meta
    }, tx.toTransactionData());
  }
  if (tx instanceof entities.NativeTransaction) {
    return _objectSpread2({
      type: TransactionType.Native
    }, tx.toTransactionData());
  }
  if (tx instanceof entities.DataTransaction) {
    return _objectSpread2({
      type: TransactionType.Data
    }, tx.toTransactionData());
  }
  sharedKernel.assertNever(tx, 'Transaction type not supported');
}
  ...
  _createClass(PendingTransactionGateway, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 13:
              ...
              if (expectedNonce) {
                sharedKernel.invariant(expectedNonce === tx.nonce, "Nonce mismatch, was expecting ".concat(expectedNonce, ", got ").concat(tx.nonce));
              }
            case 15:
          ...
          return _regeneratorRuntime().wrap(function _callee6$(_context6) {
            while (1) switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                newTransaction = differenceBy__default["default"](updatedTransactions, previousTransactions, function (tx) {
                  return tx.id;
                });
    ...
    value: function toEntity(data) {
      switch (data.type) {
        ...
        default:
          sharedKernel.assertNever(data, 'Transaction type not supported');
      }
    }
  }]);
...
var TransactionQueuePresenter = /*#__PURE__*/function () {
  ...
  _createClass(TransactionQueuePresenter, [{
    ...
    value: function clearRecent() {
      var transactions = gql.recentTransactionsVar();
      var filteredTransactions = transactions.filter(function (tx) {
        return tx.status !== gql.TxStatus.FAILED && tx.status !== gql.TxStatus.SETTLED;
      });
      gql.recentTransactionsVar(filteredTransactions);
    }
  }, {
    key: "pending",
    value: function pending(data) {
      if (gql.recentTransactionsVar().find(function (_ref) {
        var id = _ref.id;
        return id === data.id;
      })) {
        this.updateById(data.id, _objectSpread2(_objectSpread2({}, data), {}, {
          status: gql.TxStatus.PENDING
        }));
      } else {
        this.addTransaction({
          id: data.id,
    ...
    value: function addTransaction(data) {
      var transactions = gql.recentTransactionsVar();
      gql.recentTransactionsVar([data].concat(_toConsumableArray(transactions)));
    }
  }, {
    key: "updateById",
    value: function updateById(id, update) {
      var transactions = gql.recentTransactionsVar();
      gql.recentTransactionsVar(transactions.map(function (data) {
        if (id === data.id) {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return Promise.all([this.profileCacheManager.refreshCurrentProfile(), this.apolloClient.refetchQueries({
                include: [gql.OwnedHandlesDocument]
              })]);
            case 2:
            case "end":
              return _context.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Promise.all([this.profileCacheManager.refreshCurrentProfile(), this.apolloClient.refetchQueries({
                include: [gql.ProfileManagersDocument]
              })]);
            case 2:
            case "end":
              return _context.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _context.abrupt("return", sharedKernel.success(result.value.event));
            case 6:
              return _context.abrupt("return", result);
            case 7:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              this.state = result.value.state;
              return _context2.abrupt("return", sharedKernel.success(result.value.event));
            case 6:
              return _context2.abrupt("return", result);
            case 7:
            case "end":
    ...
    value: function () {
      var _waitNextEvent3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              return _context3.abrupt("return", sharedKernel.success(entities.TransactionEvent.SETTLED));
            case 1:
            case "end":
              return _context3.stop();
          }
...
var TransactionFactory = /*#__PURE__*/function () {
  ...
  _createClass(TransactionFactory, [{
    ...
    value: function createNativeTransaction(init) {
      ...
      if (entities.ProtocolTransactionKinds.includes(init.request.kind)) {
        return new SerializableNativeTransaction({
          chainType: init.chainType,
          id: init.id,
          request: init.request,
            ...
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                request = state.relayerTxId ? {
                  ...
                  txHash: (_state$txHash = state.txHash) !== null && _state$txHash !== void 0 ? _state$txHash : sharedKernel.never()
                };
                _context4.next = 3;
              ...
              case 6:
                ...
                return _context4.abrupt("return", sharedKernel.success({
                  event: entities.TransactionEvent.SETTLED,
              ...
              case 8:
                return _context4.abrupt("return", sharedKernel.success({
                  event: entities.TransactionEvent.UPGRADED,
                  state: _objectSpread2(_objectSpread2({}, state), {}, {
                    txHash: indexingEventResult.value.txHash
                  })
                }));
            ...
            while (1) switch (_context5.prev = _context5.next) {
              case 0:
                ...
                return _this5.transactionObserver.waitForConfirmation({
                  txHash: (_state$txHash2 = state.txHash) !== null && _state$txHash2 !== void 0 ? _state$txHash2 : sharedKernel.never("Cannot observe ".concat(entities.NativeTransaction.name, " on-chain without a TX hash")),
...
function resolveTransactionErrorReason(reason) {
  switch (reason) {
    case gql.DiGiTransactionFailureType.Reverted:
      return entities.TransactionErrorReason.REVERTED;
    default:
      return entities.TransactionErrorReason.UNKNOWN;
  }
}
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 12:
              ...
              return Promise.race([txResponse.wait(1), delay(this.timings.maxMiningWaitTime).then(function () {
                throw new entities.TransactionError(entities.TransactionErrorReason.MINING_TIMEOUT);
              })]);
            case 15:
            ...
            case 18:
              ...
              if (!(_context.t0 instanceof entities.TransactionError)) {
                _context.next = 22;
                break;
              }
              return _context.abrupt("return", sharedKernel.failure(_context.t0));
            case 22:
              throw _context.t0;
            case 23:
              _context.next = 4;
              break;
            case 25:
              return _context.abrupt("return", sharedKernel.failure(new entities.TransactionError(entities.TransactionErrorReason.MINING_TIMEOUT)));
            case 26:
            case "end":
              return _context.stop();
          }
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              observable = this.apolloClient.poll({
                query: gql.DiGiTransactionStatusDocument,
                variables: {
                    ...
                    var _next = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref) {
                      ...
                      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                        while (1) switch (_context2.prev = _context2.next) {
                          ...
                          case 3:
                            if (!(result.status === gql.DiGiTransactionStatusType.Failed)) {
                              _context2.next = 7;
                              break;
                            }
                            subscription.unsubscribe();
                            resolve(sharedKernel.failure(new entities.TransactionError(resolveTransactionErrorReason((_result$reason = result.reason) !== null && _result$reason !== void 0 ? _result$reason : sharedKernel.never("Missing reason")))));
                            return _context2.abrupt("return");
                          case 7:
                            if (previousTxHash === null) {
                              previousTxHash = result.txHash;
                            }
                            if (!(previousTxHash !== result.txHash || result.status === gql.DiGiTransactionStatusType.Complete)) {
                              _context2.next = 12;
                              break;
                            }
                            subscription.unsubscribe();
                            resolve(sharedKernel.success({
                              indexed: result.status === gql.DiGiTransactionStatusType.Complete,
                          ...
                          case 12:
                            if (Date.now() - startedAt > _this.timings.maxIndexingWaitTime) {
                              subscription.unsubscribe();
                              resolve(sharedKernel.failure(new entities.TransactionError(entities.TransactionErrorReason.INDEXING_TIMEOUT)));
                            }
                          case 13:
                          case "end":
                            return _context2.stop();
      ...
      var _getBalanceFor = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(wallet, asset) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              provider = _context.sent;
              contract = blockchainBindings.erc20(asset.address, provider);
              _context.next = 6;
              return contract.balanceOf(wallet.address);
            case 6:
              balance = _context.sent;
              return _context.abrupt("return", sharedKernel.Amount.erc20(asset, sharedKernel.BigDecimal.rescale(sharedKernel.BigDecimal.from(balance.toString()), -asset.decimals)));
            case 8:
            case "end":
              return _context.stop();
          }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              return _context.abrupt("return", sharedKernel.Amount.erc20(asset, sharedKernel.BigDecimal.rescale(sharedKernel.BigDecimal.from(allowance.toString()), -asset.decimals)));
            case 8:
            case "end":
              return _context.stop();
          }
...
function isUserRejectedError(err) {
  return err.code === logger.ErrorCode.ACTION_REJECTED || err.code === ethRpcErrors.errorCodes.provider.userRejectedRequest;
}

var WalletDataSchema = zod.z.object({
  address: zod.z.string()
});
var UnsignedProtocolCall = /*#__PURE__*/function () {
  ...
  _createClass(UnsignedProtocolCall, [{
    key: "nonce",
    get: function get() {
      sharedKernel.invariant(typeof this.typedData.message.nonce === 'number', 'Nonce is not defined');
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              return _context.abrupt("return", sharedKernel.failure(new entities.PendingSigningRequestError()));
            case 7:
            ...
            case 12:
              ...
              return _context.abrupt("return", sharedKernel.success(signedCall));
            case 17:
              _context.prev = 17;
              ...
              return _context.abrupt("return", sharedKernel.failure(new entities.UserRejectedError()));
            case 22:
              throw _context.t0;
            case 23:
              _context.prev = 23;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              return _context2.abrupt("return", sharedKernel.failure(new entities.PendingSigningRequestError()));
            case 7:
              this.signingInProgress = true;
              signer = result.value;
              _context2.prev = 9;
            ...
            case 12:
              ...
              return _context2.abrupt("return", sharedKernel.success(_signature2));
            case 16:
              _context2.prev = 16;
              ...
              return _context2.abrupt("return", sharedKernel.failure(new entities.UserRejectedError()));
            case 21:
              throw _context2.t0;
            case 22:
              _context2.prev = 22;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              return _context3.abrupt("return", sharedKernel.failure(new entities.PendingSigningRequestError()));
            case 7:
              this.signingInProgress = true;
              signer = result.value;
              _context3.prev = 9;
            ...
            case 12:
              ...
              return _context3.abrupt("return", sharedKernel.success(transaction));
            case 17:
              _context3.prev = 17;
              ...
              return _context3.abrupt("return", sharedKernel.failure(new entities.UserRejectedError()));
            case 22:
              if (!(_context3.t0.code === logger.ErrorCode.INSUFFICIENT_FUNDS)) {
                _context3.next = 24;
                break;
              }
              return _context3.abrupt("return", sharedKernel.failure(new entities.InsufficientGasError(sharedKernel.matic())));
            case 24:
              throw _context3.t0;
            case 25:
              _context3.prev = 25;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", (_this$inMemoryCache$k = this.inMemoryCache[key]) !== null && _this$inMemoryCache$k !== void 0 ? _this$inMemoryCache$k : sharedKernel.never());
            case 3:
    ...
    value: function () {
      var _createProvider = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(config) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              chainId = (_this$chains$config$c = (_this$chains$config$c2 = this.chains[config.chainType]) === null || _this$chains$config$c2 === void 0 ? void 0 : _this$chains$config$c2.chainId) !== null && _this$chains$config$c !== void 0 ? _this$chains$config$c : sharedKernel.never('Unable to determine chainId');
              _context.next = 3;
            ...
            case 6:
              ...
              sharedKernel.invariant(network.chainId === chainId, "Invalid chainId. Expected ".concat(chainId, " but got ").concat(network.chainId));
...
var SignerFactory = /*#__PURE__*/function () {
  ...
  _createClass(SignerFactory, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              if (blockchainBindings.isTheSameAddress(address, signerAddress)) {
                _context.next = 10;
                break;
              }
              return _context.abrupt("return", sharedKernel.failure(new entities.WalletConnectionError(entities.WalletConnectionErrorReason.WRONG_ACCOUNT)));
            case 10:
              if (!chainType) {
                _context.next = 31;
                break;
            ...
            case 26:
              ...
              assertErrorObjectWithCode(_context.t0);
              if (!(_context.t0.code === logger.ErrorCode.UNSUPPORTED_OPERATION)) {
                _context.next = 31;
                break;
              }
              return _context.abrupt("return", sharedKernel.failure(new entities.WalletConnectionError(entities.WalletConnectionErrorReason.INCORRECT_CHAIN)));
            case 31:
              return _context.abrupt("return", sharedKernel.success(signer));
            case 32:
            case "end":
              return _context.stop();
          }
    ...
    value: function createAddEthereumChainParameter(chainType) {
      ...
      return {
        chainId: bytes.hexValue(chainConfig.chainId),
      ...
      var _addChain = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(signer, chainConfig) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              if (!(signer.provider && signer.provider instanceof providers.JsonRpcProvider)) {
                _context2.next = 4;
                break;
              }
              _context2.next = 4;
      ...
      var _switchChain = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(signer, chainConfig) {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 4:
              return _context3.abrupt("return", sharedKernel.success());
            case 5:
              _context3.next = 9;
              break;
            case 7:
            ...
            case 9:
              return _context3.abrupt("return", sharedKernel.failure(new entities.WalletConnectionError(entities.WalletConnectionErrorReason.INCORRECT_CHAIN)));
            case 10:
            case "end":
              return _context3.stop();
          }
...
function createSharedDependencies(userConfig) {
  ...
  // auth api
  var anonymousApolloClient = gql.createAuthApolloClient({
  ...
  // apollo client
  var apolloClient = gql.createLensApolloClient({
  ...
  var responders = (_responders = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_responders, entities.TransactionKind.ACT_ON_PUBLICATION, new RefreshPublicationResponder(publicationCacheManager)), entities.TransactionKind.APPROVE_MODULE, new NoopResponder()), entities.TransactionKind.BLOCK_PROFILE, new BlockProfilesResponder(profileCacheManager)), entities.TransactionKind.CLAIM_HANDLE, new NoopResponder()), entities.TransactionKind.CREATE_COMMENT, new NoopResponder()), entities.TransactionKind.CREATE_POST, new NoopResponder()), entities.TransactionKind.CREATE_PROFILE, new NoopResponder()), entities.TransactionKind.CREATE_QUOTE, new NoopResponder()), entities.TransactionKind.FOLLOW_PROFILE, new FollowProfileResponder(profileCacheManager)), entities.TransactionKind.LINK_HANDLE, new LinkHandleResponder(apolloClient, profileCacheManager)), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_responders, entities.TransactionKind.MIRROR_PUBLICATION, new NoopResponder()), entities.TransactionKind.UNBLOCK_PROFILE, new UnblockProfilesResponder(profileCacheManager)), entities.TransactionKind.UNFOLLOW_PROFILE, new UnfollowProfileResponder(profileCacheManager)), entities.TransactionKind.UNLINK_HANDLE, new LinkHandleResponder(apolloClient, profileCacheManager)), entities.TransactionKind.UPDATE_FOLLOW_POLICY, new RefreshCurrentProfileResponder(profileCacheManager)), entities.TransactionKind.UPDATE_PROFILE_DETAILS, new RefreshCurrentProfileResponder(profileCacheManager)), entities.TransactionKind.UPDATE_PROFILE_MANAGERS, new UpdateProfileManagersResponder(apolloClient, profileCacheManager)));
  ...
  // common interactors
  var activeWallet = new authentication.ActiveWallet(credentialsGateway, walletGateway);
  var tokenAvailability = new wallets.TokenAvailability(balanceGateway, tokenGateway, activeWallet);
  var transactionQueue = transactions.TransactionQueue.create(responders, transactionGateway, transactionQueuePresenter);

  // logout
  var logoutPresenter = new LogoutPresenter();
  var logout = new authentication.Logout(credentialsGateway, transactionGateway, conversationsGateway, logoutPresenter);
...
var SharedDependenciesContext = /*#__PURE__*/React__default["default"].createContext(null);
/**
 * @internal
 */
function SharedDependenciesProvider(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SharedDependenciesContext.Provider, {
    value: context,
    children: children
  });
}
...
function useSharedDependencies() {
  var context = React.useContext(SharedDependenciesContext);
  sharedKernel.invariant(context, 'Could not find Lens SDK context, ensure your code is wrapped in a <LensProvider>');
  return context;
}
...
function BaseProvider(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SharedDependenciesProvider, {
...
function useDeferredTask(handler) {
  ...
  var execute = React.useCallback( /*#__PURE__*/function () {
...
var LoginPresenter = /*#__PURE__*/function () {
  function LoginPresenter(profileCacheManager) {
    ...
    _defineProperty(this, "deferredResult", new sharedKernel.Deferred());
    this.profileCacheManager = profileCacheManager;
  }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              sharedKernel.invariant(session.type !== authentication.SessionType.Anonymous, 'Unexpected anonymous session type');
              if (!(session.type === authentication.SessionType.JustWallet)) {
                _context.next = 9;
                break;
              }
              gql.updateSessionData(session);
              this.deferredResult.resolve(sharedKernel.success(null));
              return _context.abrupt("return");
            case 9:
              _context.next = 11;
            ...
            case 11:
              ...
              sharedKernel.invariant(profile, 'Profile not found');
              gql.updateSessionData(session);
              this.deferredResult.resolve(sharedKernel.success(profile));
              return _context.abrupt("return");
            case 16:
            case "end":
              return _context.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            login = new authentication.Login(walletGateway, credentialsFactory, credentialsGateway, presenter);
            _context.next = 4;
  ...
  return /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return logout.execute(authentication.LogoutReason.USER_INITIATED);
        case 2:
          return _context.abrupt("return", sharedKernel.success());
        case 3:
        case "end":
...
function useLazyFragmentVariables() {
  ...
  return function (variables) {
    ...
    return merge__default["default"]({}, config.fragmentVariables, variables);
  };
}
 ...
 */
function useSession() {
  var sessionData = gql.useSessionDataVar();
  var prevSession = usePreviousValue(sessionData);
  var trigger = (sessionData === null || sessionData === void 0 ? void 0 : sessionData.type) === authentication.SessionType.WithProfile;
  var profileId = (sessionData === null || sessionData === void 0 ? void 0 : sessionData.type) === authentication.SessionType.WithProfile ? sessionData.profileId : undefined;
  var _useProfile = gql.useProfile(useDiGiApolloClient({
  ...
  switch (sessionData.type) {
    case authentication.SessionType.Anonymous:
      return {
        data: {
          type: authentication.SessionType.Anonymous,
          authenticated: false,
    ...
    case authentication.SessionType.JustWallet:
      return {
        data: {
          type: authentication.SessionType.JustWallet,
          authenticated: true,
  ...
  if (error) {
    return {
      data: undefined,
      error: new gql.UnspecifiedError(error),
      loading: false
    };
  }
  if (!data) {
    ...
    if (prevSession.type === authentication.SessionType.WithProfile) {
      ...
      if (previousData !== null && previousData !== void 0 && previousData.result) {
        return {
          data: {
            type: authentication.SessionType.WithProfile,
            authenticated: true,
  ...
  sharedKernel.invariant(data.result, "Active Profile [ID:".concat(sessionData.profileId, "] data not found.\n") + 'This is likely an issue with UI state ported across environments.');
  return {
    data: {
      type: authentication.SessionType.WithProfile,
      address: sessionData.address,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.WalletAuthenticationToProfileAuthenticationDocument,
                variables: {
                  request: {
                    profileId: profileId
                  }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return");
            case 3:
              sharedKernel.invariant(result.value.type === authentication.SessionType.WithProfile, "You can only upgrade to session with profile");
            ...
            case 7:
              profile = _context.sent;
              sharedKernel.invariant(profile, 'Profile not found');
              gql.updateSessionData(result.value);
              this.deferredResult.resolve(sharedKernel.success(profile));
              return _context.abrupt("return");
            case 12:
            case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            upgrade = new authentication.UpgradeCredentials(credentialsUpgrader, credentialsGateway, presenter);
            _context.next = 5;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.DismissRecommendedProfilesDocument,
                variables: {
                  request: {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return this.apolloClient.refetchQueries({
                include: [gql.ProfileRecommendationsDocument]
              });
            case 2:
            case "end":
              return _context.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            dismiss = new profile.DismissRecommendedProfiles(gateway, presenter);
            _context.next = 5;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to dismiss recommended profiles.');
            _context.next = 4;
            return dismiss({
...
function useAdHocQuery(query) {
  var _useSharedDependencie = useSharedDependencies(),
    apolloClient = _useSharedDependencie.apolloClient;
  var _useLazyQuery = client.useLazyQuery(query, {
...
function usePaginatedReadResult(_ref5) {
  ...
  var cachedData = React.useRef(data).current;
  var _useState = React.useState(0),
    _useState2 = _slicedToArray(_useState, 2),
    beforeCount = _useState2[0],
    setBeforeCount = _useState2[1];
  var probeForNewerResults = React.useCallback( /*#__PURE__*/function () {
...
function useExploreProfiles() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
      orderBy: gql.ExploreProfilesOrderByType.LatestCreated
    },
    where = _ref.where,
    limit = _ref.limit,
    _ref$orderBy = _ref.orderBy,
    orderBy = _ref$orderBy === void 0 ? gql.ExploreProfilesOrderByType.LatestCreated : _ref$orderBy;
  return usePaginatedReadResult(gql.useExploreProfiles(useDiGiApolloClient({
    variables: useFragmentVariables({
      limit: limit,
      where: where,
      orderBy: orderBy
...
function useExplorePublications() {
  var _where$metadata;
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
      orderBy: gql.ExplorePublicationsOrderByType.Latest
    },
    where = _ref.where,
    _ref$orderBy = _ref.orderBy,
    orderBy = _ref$orderBy === void 0 ? gql.ExplorePublicationsOrderByType.Latest : _ref$orderBy;
  return usePaginatedReadResult(gql.useExplorePublications(useDiGiApolloClient({
    variables: useFragmentVariables({
      where: where,
      orderBy: orderBy,
...
function useFeed(_ref) {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(gql.useFeed(useDiGiApolloClient({
    variables: useFragmentVariables({
      where: where,
      statsFor: where === null || where === void 0 || (_where$metadata = where.metadata) === null || _where$metadata === void 0 ? void 0 : _where$metadata.publishedOn
    }),
    skip: (session === null || session === void 0 ? void 0 : session.type) !== authentication.SessionType.WithProfile
  })));
}
...
function useFeedHighlights(_ref) {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(gql.useFeedHighlights(useDiGiApolloClient({
    variables: useFragmentVariables({
      where: where,
      statsFor: where === null || where === void 0 || (_where$metadata = where.metadata) === null || _where$metadata === void 0 ? void 0 : _where$metadata.publishedOn
    }),
...
function useRecommendedProfiles(args) {
  return usePaginatedReadResult(gql.useProfileRecommendations(useDiGiApolloClient({
...
function useSearchProfiles(args) {
  return usePaginatedReadResult(gql.useSearchProfiles(useDiGiApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useSearchPublications(_ref) {
  ...
  var query = _ref.query,
    limit = _ref.limit,
    where = _ref.where;
  return usePaginatedReadResult(gql.useSearchPublications(useDiGiApolloClient({
    variables: useFragmentVariables({
      query: query,
      limit: limit,
      where: where,
...
function useCurrencies() {
  var _result$data;
  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var result = usePaginatedReadResult(gql.useCurrencies(useDiGiApolloClient({
    variables: args
  })));
  if (result.loading) {
    return result;
  ...
  return _objectSpread2(_objectSpread2({}, result), {}, {
    data: ((_result$data = result.data) !== null && _result$data !== void 0 ? _result$data : []).map(function (currency) {
      return sharedKernel.erc20({
        name: currency.name,
        decimals: currency.decimals,
        symbol: currency.symbol,
        address: currency.contract.address,
        chainType: gql.chainType(currency.contract.chainId)
      });
    })
  });
}
...
function useInvitedProfiles() {
  var _useSession = useSession(),
    session = _useSession.data;
  sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this query. Use `useLogin` hook to authenticate.');
  return useReadResult(gql.useInvitedProfiles(useDiGiApolloClient({
    variables: useFragmentVariables()
  })));
}
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.apolloClient.query({
                query: gql.ProfileAlreadyInvitedDocument,
                variables: {
                  request: {
                    "for": address
                  }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              _context.next = 5;
              return Promise.all([this.profileCacheManager.refreshCurrentProfile(), this.apolloClient.refetchQueries({
                include: [gql.InvitedProfilesDocument]
              })]);
            case 5:
              return _context.abrupt("return", sharedKernel.success());
            case 6:
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            inviteWallets = new wallets.InviteWallets(gateway, gateway, presenter);
            _context.next = 5;
...
function useModuleMetadata(args) {
  return useReadResult(gql.useModuleMetadata(useDiGiApolloClient({
    variables: {
      request: args
    }
  })));
...
function useLazyModuleMetadata() {
  var _useModuleMetadataLaz = gql.useModuleMetadataLazyQuery(useDiGiApolloClient({
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", sharedKernel.failure(new gql.UnspecifiedError(error)));
          case 7:
            if (data !== null && data !== void 0 && data.result) {
              _context.next = 9;
              break;
            }
            return _context.abrupt("return", sharedKernel.failure(new NotFoundError("module metadata for: ".concat(args.implementation))));
          case 9:
            return _context.abrupt("return", sharedKernel.success(data.result));
          case 10:
          case "end":
            return _context.stop();
        }
...
function useResolveAddress() {
  var _useHandleToAddressLa = gql.useHandleToAddressLazyQuery(useDiGiApolloClient()),
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", sharedKernel.failure(new gql.UnspecifiedError(error)));
          case 7:
            sharedKernel.invariant(data, 'Data must be defined');
            return _context.abrupt("return", sharedKernel.success(data.result));
          case 9:
          case "end":
            return _context.stop();
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            if (blockchainBindings.isValidHandle(request.localName)) {
              _context.next = 2;
              break;
            }
            return _context.abrupt("return", sharedKernel.failure(new InvalidHandleError(request.localName)));
          case 2:
          ...
          case 10:
            ...
            return _context.abrupt("return", sharedKernel.failure(new HandleNotAvailableError(handle)));
          case 13:
            return _context.abrupt("return", sharedKernel.success());
          case 14:
          case "end":
...
function useWasWalletInvited(args) {
  return useReadResult(gql.useProfileAlreadyInvited(useDiGiApolloClient({
    variables: {
      request: args
    }
  })));
...
function useLazyWasWalletInvited() {
  var _useProfileAlreadyInv = gql.useProfileAlreadyInvitedLazyQuery(useDiGiApolloClient()),
...
function useNotifications() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    where = _ref.where;
  return usePaginatedReadResult(gql.useNotifications(useDiGiApolloClient({
    variables: useFragmentVariables({
      where: where,
...
function useBlockedProfiles() {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated.');
  sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'You must be authenticated with a profile to use this query. Use `useLogin` hook to authenticate.');
  return usePaginatedReadResult(gql.useWhoHaveBlocked(useDiGiApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useLazyProfile() {
  var _useProfileLazyQuery = gql.useProfileLazyQuery(useDiGiApolloClient({
      fetchPolicy: 'cache-and-network'
    })),
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            return _context.abrupt("return", sharedKernel.failure(new NotFoundError("profile for: ".concat(String((_args$forProfileId = args.forProfileId) !== null && _args$forProfileId !== void 0 ? _args$forProfileId : args.forHandle)))));
          case 9:
            return _context.abrupt("return", sharedKernel.success(data.result));
          case 10:
          case "end":
...
function useLazyProfiles() {
  var _useProfilesLazyQuery = gql.useProfilesLazyQuery(useDiGiApolloClient({
      fetchPolicy: 'no-cache'
    })),
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 7:
            sharedKernel.invariant(data, 'Data must be defined');
            return _context.abrupt("return", sharedKernel.success(data.result.items));
          case 9:
          case "end":
            return _context.stop();
        }
...
function useMutualFollowers(args) {
  return usePaginatedReadResult(gql.useMutualFollowers(useDiGiApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useProfile(_ref) {
  ...
  sharedKernel.invariant(forProfileId === undefined || forHandle === undefined, "Only one of 'forProfileId' or 'forHandle' should be provided to 'useProfile' hook");
  var _useReadResult = useReadResult(gql.useProfile(useDiGiApolloClient({
      variables: useFragmentVariables({
...
function useProfileActionHistory() {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(gql.useProfileActionHistory(useDiGiApolloClient({
    variables: args,
    skip: (session === null || session === void 0 ? void 0 : session.type) !== authentication.SessionType.WithProfile
  })));
}
...
function useProfileFollowers(args) {
  return usePaginatedReadResult(gql.useFollowers(useDiGiApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useProfileFollowing(args) {
  return usePaginatedReadResult(gql.useFollowing(useDiGiApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useProfileManagers(args) {
  return usePaginatedReadResult(gql.useProfileManagers(useDiGiApolloClient({
    variables: {
      request: args
    }
  })));
...
function useProfiles(args) {
  return usePaginatedReadResult(gql.useProfiles(useDiGiApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
var mapReportReasonToInput$1 = function mapReportReasonToInput(reason) {
  switch (reason) {
    case entities.ProfileReportReason.IMPERSONATION:
      return {
        fraudReason: {
          reason: gql.ProfileReportingReason.Fraud,
          subreason: gql.ProfileReportingFraudSubreason.Impersonation
        }
      };
    case entities.ProfileReportReason.FRAUD_SOMETHING_ELSE:
      return {
        fraudReason: {
          reason: gql.ProfileReportingReason.Fraud,
          subreason: gql.ProfileReportingFraudSubreason.SomethingElse
        }
      };
    case entities.ProfileReportReason.REPETITIVE:
      return {
        spamReason: {
          reason: gql.ProfileReportingReason.Spam,
          subreason: gql.ProfileReportingSpamSubreason.Repetitive
        }
      };
    case entities.ProfileReportReason.SPAM_SOMETHING_ELSE:
      return {
        spamReason: {
          reason: gql.ProfileReportingReason.Spam,
          subreason: gql.ProfileReportingSpamSubreason.SomethingElse
        }
      };
    default:
      sharedKernel.assertNever(reason, "Unknown report type");
  }
};
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.ReportProfileDocument,
                variables: {
                  request: {
                    "for": profileId,
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            reportProfile = new profile.ReportProfile(gateway, presenter);
            _context.next = 5;
...
function useWhoActedOnPublication(args) {
  return usePaginatedReadResult(gql.useWhoActedOnPublication(useDiGiApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useBookmarks() {
  ...
  var _useSession = useSession(),
    session = _useSession.data;
  return usePaginatedReadResult(gql.usePublicationBookmarks(useDiGiApolloClient({
    variables: useFragmentVariables({
      request: args,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.AddPublicationBookmarkDocument,
                variables: {
                  request: {
                    on: publicationId
                  }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.RemovePublicationBookmarkDocument,
                variables: {
                  request: {
                    on: publicationId
                  }
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              this.publicationCacheManager.update(publicationId, function (current) {
                if (!gql.isPrimaryPublication(current)) {
                  return current;
                }
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            bookmark = new publications.ToggleProperty(gateway, presenter);
            _context.next = 5;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            target = gql.isMirrorPublication(publication) ? publication.mirrorOn : publication;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.HideCommentDocument,
                variables: {
                  request: {
                    "for": publicationId
                  }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.UnhideCommentDocument,
                variables: {
                  request: {
                    "for": publicationId
                  }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              publicationId = _ref.publicationId;
              this.publicationCacheManager.update(publicationId, function (current) {
                if (!gql.isCommentPublication(current)) {
                  return current;
                }
                return _objectSpread2(_objectSpread2({}, current), {}, {
                  hiddenByAuthor: true
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            comment = new publications.ToggleProperty(gateway, presenter);
            _context.next = 5;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            presenter = new HideCommentPresenter(publicationCacheManager);
            gateway = new HideCommentGateway(apolloClient);
            reaction = new publications.ToggleProperty(gateway, presenter);
            _context2.next = 5;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'You must be authenticated with a profile to use this query. Use `useLogin` hook to authenticate.');
            sharedKernel.invariant(gql.isCommentPublication(comment), 'Publication is not a Comment.');
            sharedKernel.invariant(comment.commentOn.by.id === session.profile.id, 'You can only hide comments on publications that you have authored.');
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.HidePublicationDocument,
                variables: {
                  request: {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            hidePublication = new publications.HidePublication(gateway, presenter);
            _context.next = 6;
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            publication = _ref.publication;
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to hide a publication');
            sharedKernel.invariant(publication.by.ownedBy.address === session.address, 'Publication not owned by the active wallet. Make sure that publication is owned by the wallet before trying to hide it.');
            _context.next = 5;
            return hide({
...
function useLazyPublication() {
  var _usePublicationLazyQu = gql.usePublicationLazyQuery(useDiGiApolloClient({
      fetchPolicy: 'cache-and-network'
    })),
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            return _context.abrupt("return", sharedKernel.failure(new NotFoundError("publication for: ".concat(String((_args$forId = args.forId) !== null && _args$forId !== void 0 ? _args$forId : args.forTxHash)))));
          case 9:
            return _context.abrupt("return", sharedKernel.success(data.result));
          case 10:
          case "end":
...
function useLazyPublications() {
  var _usePublicationsLazyQ = gql.usePublicationsLazyQuery(useDiGiApolloClient({
      fetchPolicy: 'no-cache'
    })),
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.AddPublicationNotInterestedDocument,
                variables: {
                  request: {
                    on: publicationId
                  }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.UndoPublicationNotInterestedDocument,
                variables: {
                  request: {
                    on: publicationId
                  }
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            publication = _ref.publication;
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            _ref3 = gql.isMirrorPublication(publication) ? publication.mirrorOn : publication, publicationId = _ref3.id, isNotInterested = _ref3.operations.isNotInterested;
            if (!isNotInterested) {
              _context.next = 8;
              break;
            }
...
function usePublication(_ref) {
  ...
  sharedKernel.invariant(forId === undefined || forTxHash === undefined, "Only one of 'forId' or 'forTxHash' should be provided to 'usePublication' hook");
  var _useReadResult = useReadResult(gql.usePublication(useDiGiApolloClient({
      variables: useFragmentVariables({
...
function usePublications(_ref) {
  ...
  var where = _ref.where,
    limit = _ref.limit;
  return usePaginatedReadResult(gql.usePublications(useDiGiApolloClient({
    variables: useFragmentVariables({
      where: where,
      limit: limit,
      statsFor: where === null || where === void 0 || (_where$metadata = where.metadata) === null || _where$metadata === void 0 ? void 0 : _where$metadata.publishedOn
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.AddReactionDocument,
                variables: {
                  request: {
                    "for": request.publicationId,
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.RemoveReactionDocument,
                variables: {
                  request: {
                    "for": request.publicationId,
                    reaction: request.reaction
...
function updateOperationsOnAdd(reaction) {
  switch (reaction) {
    case gql.PublicationReactionType.Upvote:
      return {
        hasUpvoted: true
      };
    case gql.PublicationReactionType.Downvote:
      return {
        hasDownvoted: true
      };
  }
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            sharedKernel.invariant(gql.isPrimaryPublication(publication), 'Publication is not a primary publication');
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            if (!hasReacted({
...
var mapReportReasonToInput = function mapReportReasonToInput(reason) {
  switch (reason) {
    case entities.PublicationReportReason.VIOLENCE:
      return {
        illegalReason: {
          reason: gql.PublicationReportingReason.Illegal,
          subreason: gql.PublicationReportingIllegalSubreason.Violence
        }
      };
    case entities.PublicationReportReason.SELF_HARM:
      return {
        illegalReason: {
          reason: gql.PublicationReportingReason.Illegal,
          subreason: gql.PublicationReportingIllegalSubreason.ThreatIndividual
        }
      };
    case entities.PublicationReportReason.DIRECT_THREAT:
      return {
        illegalReason: {
          reason: gql.PublicationReportingReason.Illegal,
          subreason: gql.PublicationReportingIllegalSubreason.DirectThreat
        }
      };
    case entities.PublicationReportReason.HARASSMENT:
    case entities.PublicationReportReason.HATE_SPEECH:
      return {
        illegalReason: {
          reason: gql.PublicationReportingReason.Illegal,
          subreason: gql.PublicationReportingIllegalSubreason.HumanAbuse
        }
      };
    case entities.PublicationReportReason.ANIMAL_ABUSE:
      return {
        illegalReason: {
          reason: gql.PublicationReportingReason.Illegal,
          subreason: gql.PublicationReportingIllegalSubreason.AnimalAbuse
        }
      };
    case entities.PublicationReportReason.SCAM:
    case entities.PublicationReportReason.UNAUTHORIZED_SALE:
      return {
        fraudReason: {
          reason: gql.PublicationReportingReason.Fraud,
          subreason: gql.PublicationReportingFraudSubreason.Scam
        }
      };
    case entities.PublicationReportReason.IMPERSONATION:
      return {
        fraudReason: {
          reason: gql.PublicationReportingReason.Fraud,
          subreason: gql.PublicationReportingFraudSubreason.Impersonation
        }
      };
    case entities.PublicationReportReason.NUDITY:
      return {
        sensitiveReason: {
          reason: gql.PublicationReportingReason.Sensitive,
          subreason: gql.PublicationReportingSensitiveSubreason.Nsfw
        }
      };
    case entities.PublicationReportReason.OFFENSIVE:
      return {
        sensitiveReason: {
          reason: gql.PublicationReportingReason.Sensitive,
          subreason: gql.PublicationReportingSensitiveSubreason.Offensive
        }
      };
    case entities.PublicationReportReason.MISLEADING:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
          subreason: gql.PublicationReportingSpamSubreason.Misleading
        }
      };
    case entities.PublicationReportReason.MISUSE_HASHTAGS:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
          subreason: gql.PublicationReportingSpamSubreason.MisuseHashtags
        }
      };
    case entities.PublicationReportReason.UNRELATED:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
          subreason: gql.PublicationReportingSpamSubreason.Unrelated
        }
      };
    case entities.PublicationReportReason.REPETITIVE:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
          subreason: gql.PublicationReportingSpamSubreason.Repetitive
        }
      };
    case entities.PublicationReportReason.FAKE_ENGAGEMENT:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
          subreason: gql.PublicationReportingSpamSubreason.FakeEngagement
        }
      };
    case entities.PublicationReportReason.MANIPULATION_ALGO:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
          subreason: gql.PublicationReportingSpamSubreason.ManipulationAlgo
        }
      };
    case entities.PublicationReportReason.SOMETHING_ELSE:
      return {
        spamReason: {
          reason: gql.PublicationReportingReason.Spam,
          subreason: gql.PublicationReportingSpamSubreason.SomethingElse
        }
      };
    default:
      sharedKernel.assertNever(reason, "Unknown report type");
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.ReportPublicationDocument,
                variables: {
                  request: {
                    "for": publicationId,
                    additionalComments: additionalComments,
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            presenter = new PromiseResultPresenter();
            reportPublication = new publications.ReportPublication(gateway, presenter);
            _context.next = 5;
...
function useWhoReactedToPublication(args) {
  return usePaginatedReadResult(gql.useWhoReactedPublication(useDiGiApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
function useRevenueFromFollow(args) {
  var _useReadResult = useReadResult(gql.useFollowRevenues(useDiGiApolloClient({
      variables: useFragmentVariables({
        request: args
      })
    }))),
...
function useRevenueFromPublication(args) {
  var _useReadResult = useReadResult(gql.useRevenueFromPublication(useDiGiApolloClient({
      variables: useFragmentVariables({
        request: args,
...
function useRevenueFromPublications(args) {
  return usePaginatedReadResult(gql.useRevenueFromPublications(useDiGiApolloClient({
...
function formatZodInvalidUnionIssue(issue) {
  var groups = issue.unionErrors.map(function (zodError) {
    return zodError.issues.map(function (nested) {
      if (sharedKernel.hasAtLeastOne(nested.path)) {
  ...
  var prefix = sharedKernel.hasAtLeastOne(path) ? "\"".concat(formatPath(path), "\": ") : '';
  if (sharedKernel.hasTwoOrMore(uniqueGroups)) {
...
function formatZodIssue(issue) {
  if (issue.code === zod.z.ZodIssueCode.invalid_union) {
    return formatZodInvalidUnionIssue(issue);
  }
  if (sharedKernel.hasAtLeastOne(issue.path)) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (result.error instanceof entities.TransactionError) {
                _context.next = 4;
                break;
              }
              this.earlyFailure = sharedKernel.failure(result.error);
              return _context.abrupt("return");
            case 4:
              this.deferredResult.resolve(sharedKernel.failure(result.error));
              return _context.abrupt("return");
            case 6:
              _context.next = 8;
            ...
            case 8:
              publication = _context.sent;
              this.deferredResult.resolve(sharedKernel.success(publication));
            case 10:
            case "end":
              return _context.stop();
          }
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              return _context2.abrupt("return", UnsignedProtocolCall.create({
                id: result.id,
                request: request,
                typedData: gql.omitTypename(result.typedData)
              }));
            case 5:
            case "end":
              return _context2.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.CommentOnMomokaDocument,
                variables: {
                  request: input
                }
              });
            ...
            case 7:
              return _context3.abrupt("return", sharedKernel.success(data.result));
            case 8:
            case "end":
              return _context3.stop();
          }
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateMomokaCommentTypedDataDocument,
                variables: {
                  request: request
                }
              });
...
function computeFeeHistoryStats(result) {
  ...
  while (blockNum < oldestBlock + result.reward.length) {
    ...
    blocks.push({
      number: blockNum,
      baseFeePerGas: sharedKernel.BigDecimal.from((_result$baseFeePerGas = result.baseFeePerGas[index]) !== null && _result$baseFeePerGas !== void 0 ? _result$baseFeePerGas : sharedKernel.never("Cannot find baseFeePerGas for block ".concat(blockNum))),
      priorityFeePerGas: ((_result$reward$index = result.reward[index]) !== null && _result$reward$index !== void 0 ? _result$reward$index : sharedKernel.never("Cannot find reward for block ".concat(blockNum))).map(function (x) {
        return sharedKernel.BigDecimal.from(x);
      })
    });
    blockNum += 1;
    index += 1;
  ...
  return {
    blocks: blocks,
    baseFee: ((_blocks = blocks[blocks.length - 1]) !== null && _blocks !== void 0 ? _blocks : sharedKernel.never('Cannot index last block')).baseFeePerGas
  };
}
...
function computeMaxPriorityFeePerGas(blocks, speed) {
  ...
  return sharedKernel.BigDecimal.mean(blocks.map(function (b) {
    var _b$priorityFeePerGas$;
    return (_b$priorityFeePerGas$ = b.priorityFeePerGas[index]) !== null && _b$priorityFeePerGas$ !== void 0 ? _b$priorityFeePerGas$ : sharedKernel.never('Cannot find priorityFeePerGas for the specified transactions execution speed');
  }));
}
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _context.abrupt("return", new Eip1559GasPriceEstimate(this.createAmount(sharedKernel.Denomination.wei(baseFee)), this.createAmount(sharedKernel.Denomination.wei(maxPriorityFeePerGas))));
            case 7:
            case "end":
              return _context.stop();
          }
...
var UnsignedContractCallTransaction = /*#__PURE__*/function (_ref) {
  ...
  function UnsignedContractCallTransaction(request, transactionRequest) {
    ...
    _this = _callSuper(this, UnsignedContractCallTransaction, [uuid.v4(), sharedKernel.ChainType.POLYGON, request]);
    _this.transactionRequest = transactionRequest;
    return _this;
  }
  return _createClass(UnsignedContractCallTransaction);
}(entities.UnsignedTransaction);
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 14:
              ...
              gasEstimator = new Eip1559GasPriceEstimator(provider, function (v) {
                return sharedKernel.Amount.matic(v);
              });
              _context.next = 18;
            ...
            case 18:
              ...
              transactionRequest = {
                ...
                data: encodedData,
                gasLimit: gasLimit,
                maxFeePerGas: blockchainBindings.bigNumber(gasPriceEstimate.maxFeePerGas),
                maxPriorityFeePerGas: blockchainBindings.bigNumber(gasPriceEstimate.maxPriorityFeePerGas),
                type: 2,
                // EIP-1559
                value: value
              };
...
function resolveOpenActionModuleInput(config) {
  ...
  switch (config.type) {
    case publications.OpenActionType.SIMPLE_COLLECT:
      return {
        collectOpenAction: {
    ...
    case publications.OpenActionType.MULTIRECIPIENT_COLLECT:
      return {
        collectOpenAction: {
    ...
    case publications.OpenActionType.UNKNOWN_OPEN_ACTION:
      return {
        unknownOpenAction: {
...
function resolveReferenceModuleInput(config) {
  switch (config.type) {
    case publications.ReferencePolicyType.FOLLOWERS_ONLY:
      return {
        followerOnlyReferenceModule: true
      };
    case publications.ReferencePolicyType.DEGREES_OF_SEPARATION:
      return {
        degreesOfSeparationReferenceModule: config.params
      };
    case publications.ReferencePolicyType.NO_ONE:
      return {
...
var CreateOnChainCommentGateway = /*#__PURE__*/function (_ref) {
  ...
  _createClass(CreateOnChainCommentGateway, [{
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.CommentOnchainDocument,
                variables: {
                  request: input
                }
              });
            ...
            case 7:
              return _context4.abrupt("return", sharedKernel.success(data.result));
            case 8:
            case "end":
              return _context4.stop();
          }
    ...
    value: function createCommentCallDetails(result) {
      var contract = blockchainBindings.digiHub(result.typedData.domain.verifyingContract);
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateOnchainCommentTypedDataDocument,
                variables: {
                  request: request,
                  options: nonce ? {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            onChainComment = new transactions.SignedOnChain(activeWallet, transactionGateway, onChainGateway, onChainRelayer, transactionQueue, presenter);
            delegableOnChainComment = new transactions.DelegableSigning(onChainComment, onChainGateway, transactionQueue, presenter);
            offChainGateway = new CreateMomokaCommentGateway(apolloClient, transactionFactory);
            momokaComment = new transactions.SubsidizeOffChain(activeWallet, offChainGateway, momokaRelayer, transactionQueue, presenter);
            delegableMomokaComment = new transactions.DelegableSigning(momokaComment, offChainGateway, transactionQueue, presenter);
            paidOnChainQuote = new transactions.PaidTransaction(activeWallet, onChainGateway, presenter, transactionQueue);
            createComment = new publications.CreateComment(delegableOnChainComment, delegableMomokaComment, paidOnChainQuote);
            _context.next = 11;
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to create a comment. Use `useLogin` hook to authenticate.');
            sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'You must have a profile to create a comment.');
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.MirrorOnMomokaDocument,
                variables: {
                  request: input
                }
              });
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateMomokaMirrorTypedDataDocument,
                variables: {
                  request: request
                }
              });
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.MirrorOnchainDocument,
                variables: {
                  request: input
                }
              });
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateOnchainMirrorTypedDataDocument,
                variables: {
                  request: request,
                  options: nonce ? {
                    overrideSigNonce: nonce
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            onChainMirror = new transactions.SignedOnChain(activeWallet, transactionGateway, onChainGateway, onChainRelayer, transactionQueue, presenter);
            delegableOnChainMirror = new transactions.DelegableSigning(onChainMirror, onChainGateway, transactionQueue, presenter);
            offChainGateway = new CreateMomokaMirrorGateway(apolloClient, transactionFactory);
            momokaMirror = new transactions.SubsidizeOffChain(activeWallet, offChainGateway, momokaRelayer, transactionQueue, presenter);
            delegableMomokaMirror = new transactions.DelegableSigning(momokaMirror, offChainGateway, transactionQueue, presenter);
            paidOnChainQuote = new transactions.PaidTransaction(activeWallet, onChainGateway, presenter, transactionQueue);
            createMirror = new publications.CreateMirror(delegableOnChainMirror, delegableMomokaMirror, paidOnChainQuote);
            _context.next = 11;
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to create a mirror. Use `useLogin` hook to authenticate.');
            sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'You must have a profile to create a mirror.');
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.PostOnMomokaDocument,
                variables: {
                  request: input
                }
              });
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateMomokaPostTypedDataDocument,
                variables: {
                  request: request
                }
              });
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.PostOnchainDocument,
                variables: {
                  request: input
                }
              });
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            onChainPost = new transactions.SignedOnChain(activeWallet, transactionGateway, onChainGateway, onChainRelayer, transactionQueue, presenter);
            delegableOnChainPost = new transactions.DelegableSigning(onChainPost, onChainGateway, transactionQueue, presenter);
            offChainGateway = new CreateMomokaPostGateway(apolloClient, transactionFactory);
            momokaPost = new transactions.SubsidizeOffChain(activeWallet, offChainGateway, momokaRelayer, transactionQueue, presenter);
            delegableMomokaPost = new transactions.DelegableSigning(momokaPost, offChainGateway, transactionQueue, presenter);
            paidOnChainPost = new transactions.PaidTransaction(activeWallet, onChainGateway, presenter, transactionQueue);
            createPost = new publications.CreatePost(delegableOnChainPost, delegableMomokaPost, paidOnChainPost);
            _context.next = 11;
...
function extractUnknownOpenActionModuleAddresses(desired) {
  return desired.actions.reduce(function (addresses, action) {
    if (action.type === publications.OpenActionType.UNKNOWN_OPEN_ACTION) {
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated with a Profile to post. Use `useLogin` hook to authenticate.');
            _context.next = 3;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.QuoteOnMomokaDocument,
                variables: {
                  request: input
                }
              });
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateMomokaQuoteTypedDataDocument,
                variables: {
                  request: request
                }
              });
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.QuoteOnchainDocument,
                variables: {
                  request: input
                }
              });
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateOnchainQuoteTypedDataDocument,
                variables: {
                  request: request,
                  options: nonce ? {
                    overrideSigNonce: nonce
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            onChainQuote = new transactions.SignedOnChain(activeWallet, transactionGateway, onChainGateway, onChainRelayer, transactionQueue, presenter);
            delegableOnChainQuote = new transactions.DelegableSigning(onChainQuote, onChainGateway, transactionQueue, presenter);
            offChainGateway = new CreateMomokaQuoteGateway(apolloClient, transactionFactory);
            momokaQuote = new transactions.SubsidizeOffChain(activeWallet, offChainGateway, momokaRelayer, transactionQueue, presenter);
            delegableMomokaQuote = new transactions.DelegableSigning(momokaQuote, offChainGateway, transactionQueue, presenter);
            paidOnChainQuote = new transactions.PaidTransaction(activeWallet, onChainGateway, presenter, transactionQueue);
            createQuote = new publications.CreateQuote(delegableOnChainQuote, delegableMomokaQuote, paidOnChainQuote);
            _context.next = 11;
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to create a quote. Use `useLogin` hook to authenticate.');
            sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'You must have a profile to create a quote.');
...
function resolveApproveAmount(request) {
  switch (request.limit) {
    case transactions.TokenAllowanceLimit.EXACT:
      return blockchainBindings.bigNumber(request.amount);
    case transactions.TokenAllowanceLimit.INFINITE:
    ...
    value: function () {
      var _createCallDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              contract = blockchainBindings.erc20(request.amount.asset.address);
...
var TransactionResultPresenter = /*#__PURE__*/function () {
  ...
  _createClass(TransactionResultPresenter, [{
    ...
    value: function present(result) {
      ...
      this.deferredResult.resolve(sharedKernel.success());
    }
  }, {
    key: "asResult",
    value: function asResult() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            tokenAllowance = new transactions.TokenAllowance(activeWallet, approveTransactionGateway, presenter, transactionQueue);
            _context.next = 5;
...
function useApproveModule() {
  var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    limit: transactions.TokenAllowanceLimit.EXACT
  };
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            on = _ref.on;
            request = gql.resolveTokenAllowanceRequest(on, args.limit);
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateBlockProfilesTypedDataDocument,
                variables: {
                  request: {
                    profiles: request.profileIds
                  },
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            signedExecution = new transactions.SignedOnChain(activeWallet, transactionGateway, gateway, onChainRelayer, transactionQueue, presenter);
            delegableExecution = new transactions.DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new transactions.PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
            blockProfile = new profile.BlockProfiles(delegableExecution, paidExecution);
            _context.next = 8;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated with a profile to block a profile. Use `useLogin` hook to authenticate.');
            return _context.abrupt("return", blockProfile(configureRequest({
              profileIds: profiles.map(function (profile) {
                return profile.id;
              }),
              kind: entities.TransactionKind.BLOCK_PROFILE,
              signless: session.profile.signless,
      ...
      var _present = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(result) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 6:
              _context.next = 8;
              return this.profileCacheManager.fetchProfileByHandle(profile.isClaimReservedHandleRequest(result.value.request) ? result.value.request.handle : this.fullHandleResolver(result.value.request.localName));
            case 8:
              profile$1 = _context.sent;
              sharedKernel.invariant(profile$1, 'Profile not found');
              this.deferredResult.resolve(sharedKernel.success(profile$1));
            case 11:
            case "end":
              return _context.stop();
          }
...
function resolveClaimProfileWithHandleRequest(request) {
  if (profile.isClaimReservedHandleRequest(request)) {
    return {
      id: request.id,
      followModule: request.followPolicy ? gql.resolveFollowModuleInput(request.followPolicy) : null
    };
  }
  return {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.ClaimProfileWithHandleDocument,
                variables: {
            ...
            case 2:
              ...
              return _context.abrupt("return", sharedKernel.failure(new profile.ClaimHandleError(profile.isClaimReservedHandleRequest(request) ? request.handle : request.localName, data.result.reason)));
            case 6:
              transaction = this.transactionFactory.createNativeTransaction({
                chainType: sharedKernel.ChainType.POLYGON,
                id: uuid.v4(),
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            claimHandle = new profile.ClaimHandle(gateway, transactionQueue, presenter);
            _context.next = 5;
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.JustWallet, 'You must be authenticated with just a wallet to claim an handle. Use `useLogin` hook omitting the profileId.');
            request = "reserved" in args && args.reserved ? {
              kind: entities.TransactionKind.CLAIM_HANDLE,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              contract = blockchainBindings.permissionlessCreator(this.config.environment.contracts.permissionlessCreator, provider);
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              _context2.next = 4;
              return this.apolloClient.query({
                query: gql.GenerateDiGiApiRelayAddressDocument
              });
            case 4:
              _yield$this$apolloCli = _context2.sent;
              data = _yield$this$apolloCli.data;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            createProfile = new profile.CreateProfile(walletGateway, gateway, presenter, transactionQueue);
            _context.next = 5;
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            return _context.abrupt("return", createProfile({
              kind: entities.TransactionKind.CREATE_PROFILE,
              localName: args.localName,
              to: args.to,
...
function resolveProfileFollow(request) {
  if (profile.isPaidFollowRequest(request)) {
    return [{
  ...
  if (profile.isUnknownFollowRequest(request)) {
    return [{
      profileId: request.profileId,
      followModule: {
        unknownFollowModule: {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateFollowTypedDataDocument,
                variables: {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            delegableExecution = new transactions.DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new transactions.PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
            followProfile = new profile.FollowProfile(tokenAvailability, signedExecution, delegableExecution, paidExecution, presenter);
            _context.next = 9;
...
function createFollowRequest(args, session) {
  ...
  sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
  sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'You must have a profile to use this operation.');
  var followPolicy = gql.resolveFollowPolicy(args.profile);
  switch (followPolicy.type) {
    case profile.FollowPolicyType.CHARGE:
      return {
        kind: entities.TransactionKind.FOLLOW_PROFILE,
        fee: {
    ...
    case profile.FollowPolicyType.UNKNOWN:
      return {
        ...
        data: (_ref = args.data) !== null && _ref !== void 0 ? _ref : sharedKernel.never("Profile ".concat(args.profile.id, " is configured with Unknown Follow Module ").concat(followPolicy.contractAddress, ". ") + 'You MUST provide `data` to execute Unknown Follow Modules. ' + 'If a module does not require processing calldata just use `0x` string.'),
    ...
    case profile.FollowPolicyType.NO_ONE:
      throw new sharedKernel.InvariantError("The profile is configured so that nobody can follow it.");
  }
}
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant(args.profile.operations.canFollow === gql.TriStateValue.Yes, "You can't follow this profile. Check the `profile.operations.canFollow` beforehand.");
            if (args.profile.operations.isFollowedByMe.isFinalisedOnchain) {
              _context.next = 3;
              break;
            }
            return _context.abrupt("return", sharedKernel.failure(new PrematureFollowError("A previous unfollow request for ".concat(args.profile.id, " is still pending.\n          Check 'profile.operations.isFollowedByMe.isFinalisedOnchain' beforehand."))));
          case 3:
...
var LinkHandleGateway = /*#__PURE__*/function (_ref) {
  ...
  _createClass(LinkHandleGateway, [{
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.LinkHandleToProfileDocument,
                variables: {
                  request: {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateLinkHandleToProfileTypedDataDocument,
                variables: {
                  request: {
                    handle: request.fullHandle
                  },
    ...
    value: function createLinkCallDetails(result) {
      var contract = blockchainBindings.digiTokenHandleRegistry(result.typedData.domain.verifyingContract);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            delegableExecution = new transactions.DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new transactions.PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
            linkHandle = new profile.LinkHandle(delegableExecution, paidExecution);
            _context.next = 9;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'You must have a profile to use this operation.');
            sharedKernel.invariant(!args.handle.linkedTo, "The handle is already linked to profile ".concat((_args$handle$linkedTo = args.handle.linkedTo) === null || _args$handle$linkedTo === void 0 ? void 0 : _args$handle$linkedTo.nftTokenId, "."));
            return _context.abrupt("return", linkHandle(configureRequest({
              kind: entities.TransactionKind.LINK_HANDLE,
...
var OpenActionGateway = /*#__PURE__*/function (_ref) {
  ...
  _createClass(OpenActionGateway, [{
    ...
    value: function () {
      var _createUnsignedProtocolCall = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(request, nonce) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              if (!(request.type === publications.AllOpenActionType.LEGACY_COLLECT)) {
                _context2.next = 2;
                break;
              }
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.LegacyCollectDocument,
                variables: {
                  request: input
                }
              });
            ...
            case 7:
              return _context6.abrupt("return", sharedKernel.success(data.result));
            case 8:
            case "end":
              return _context6.stop();
          }
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 3;
              return this.apolloClient.mutate({
                mutation: gql.ActOnOpenActionDocument,
                variables: {
                  request: input
                }
              });
            ...
            case 7:
              return _context7.abrupt("return", sharedKernel.success(data.result));
            case 8:
            case "end":
              return _context7.stop();
          }
    ...
    value: function resolveActOnOpenActionRequest(request) {
      switch (request.type) {
        case publications.AllOpenActionType.SIMPLE_COLLECT:
          return {
            "for": request.publicationId,
            actOn: {
        ...
        case publications.AllOpenActionType.MULTIRECIPIENT_COLLECT:
          return {
            "for": request.publicationId,
            actOn: {
        ...
        case publications.AllOpenActionType.UNKNOWN_OPEN_ACTION:
          return {
            "for": request.publicationId,
            actOn: {
              unknownOpenAction: {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              _context9.next = 2;
              return this.apolloClient.mutate({
                mutation: gql__namespace.CreateLegacyCollectTypedDataDocument,
                variables: {
                  request: request,
                  options: nonce ? {
                    overrideSigNonce: nonce
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              _context10.next = 2;
              return this.apolloClient.mutate({
                mutation: gql__namespace.CreateActOnOpenActionTypedDataDocument,
                variables: {
                  request: request,
                  options: nonce ? {
                    overrideSigNonce: nonce
    ...
    value: function createPublicActProxyCallDetails(request, result) {
      if (request.type == publications.AllOpenActionType.UNKNOWN_OPEN_ACTION || request.type == publications.AllOpenActionType.SIMPLE_COLLECT && !request.fee) {
    ...
    value: function createPublicFreeActCallDetails(result) {
      var contract = blockchainBindings.publicActProxy(result.typedData.domain.verifyingContract);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            signedExecution = new transactions.SignedOnChain(activeWallet, transactionGateway, onChainGateway, onChainRelayer, transactionQueue, presenter);
            delegableExecution = new transactions.DelegableSigning(signedExecution, onChainGateway, transactionQueue, presenter);
            paidExecution = new transactions.PaidTransaction(activeWallet, onChainGateway, presenter, transactionQueue);
            openAction = new publications.OpenAction(tokenAvailability, signedExecution, delegableExecution, paidExecution, presenter);
            _context.next = 8;
...
function resolveCollectRequestFor(args, params, session) {
  ...
  var settings = gql.findCollectModuleSettings(collectable);
  var sponsored = session.type === authentication.SessionType.WithProfile ? args.sponsored : false;
  // technically profile.sponsor cannot be false if profile.signless is true, but we want to be explicit here
  var signless = session.type === authentication.SessionType.WithProfile && sponsored && session.profile.signless;
  ...
  switch (settings.__typename) {
    ...
    case 'LegacySimpleCollectModuleSettings':
      sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'Legacy collect cannot be collected with just a wallet');
      return {
        ...
        fee: {
          amount: gql.erc20Amount(settings.amount),
    ...
    case 'SimpleCollectOpenActionSettings':
      var amount = gql.erc20Amount(settings.amount);
      return {
        kind: entities.TransactionKind.ACT_ON_PUBLICATION,
        ...
        "public": session.type === authentication.SessionType.JustWallet,
        signless: signless,
        sponsored: sponsored
      };
...
function resolveUnknownRequestFor(args, params, session) {
  ...
  })) !== null && _target$openActionMod !== void 0 ? _target$openActionMod : sharedKernel.never("Cannot find Open Action settings ".concat(params.address, " fro publication ").concat(target.id));
  return _objectSpread2({
    kind: entities.TransactionKind.ACT_ON_PUBLICATION,
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to execute an Open Action a post. Use `useLogin` hook to authenticate.');
            sharedKernel.invariant(publication.momoka === null, 'You cannot execute an Open Action on a Momoka publication.');
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              return _context2.abrupt("return", UnsignedProtocolCall.create({
                id: data.id,
                request: request,
                typedData: gql.omitTypename(data.typedData)
              }));
            case 4:
            case "end":
              return _context2.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.SetProfileMetadataDocument,
                variables: {
                  request: {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateOnchainSetProfileMetadataTypedDataDocument,
                variables: {
                  request: {
                    metadataURI: request.metadataURI
                  },
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            delegableExecution = new transactions.DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new transactions.PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
            setProfileMetadata = new profile.SetProfileMetadata(delegableExecution, paidExecution);
            _context.next = 8;
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated to set profile metadata. Use `useLogin` hook to authenticate.');
            request = configureRequest({
              kind: entities.TransactionKind.UPDATE_PROFILE_DETAILS,
              signless: session.profile.signless,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _context.abrupt("return", sharedKernel.failure(result.error));
            case 5:
              transaction = this.transactionFactory.createNativeTransaction({
                chainType: sharedKernel.ChainType.POLYGON,
                id: uuid.v4(),
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateUnblockProfilesTypedDataDocument,
                variables: {
                  request: {
                    profiles: request.profileIds
                  },
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            delegableExecution = new transactions.DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new transactions.PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
            blockProfile = new profile.UnblockProfiles(delegableExecution, paidExecution);
            _context.next = 8;
            return blockProfile.execute(request);
          case 8:
            return _context.abrupt("return", presenter.asResult());
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            profiles = _ref.profiles, sponsored = _ref.sponsored;
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated with a profile to unblock a profile. Use `useLogin` hook to authenticate.');
            return _context.abrupt("return", unblockProfile(configureRequest({
              profileIds: profiles.map(function (profile) {
                return profile.id;
              }),
              kind: entities.TransactionKind.UNBLOCK_PROFILE,
              signless: session.profile.signless,
              sponsored: sponsored !== null && sponsored !== void 0 ? sponsored : true
            })));
          case 3:
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateUnfollowTypedDataDocument,
                variables: {
                  request: {
                    unfollow: [request.profileId]
                  },
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            delegableExecution = new transactions.DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new transactions.PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
            unfollowProfile = new profile.UnfollowProfile(delegableExecution, paidExecution);
            _context.next = 9;
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", unfollowProfile(configureRequest({
              kind: entities.TransactionKind.UNFOLLOW_PROFILE,
              profileId: args.profile.id,
              signless: session.profile.signless,
              sponsored: (_args$sponsored = args.sponsored) !== null && _args$sponsored !== void 0 ? _args$sponsored : true
            })));
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.UnlinkHandleFromProfileDocument,
                variables: {
                  request: {
                    handle: request.fullHandle
                  }
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateUnlinkHandleFromProfileTypedDataDocument,
                variables: {
                  request: {
                    handle: request.fullHandle
                  },
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            delegableExecution = new transactions.DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new transactions.PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
            unlinkHandle = new profile.UnlinkHandle(delegableExecution, paidExecution);
            _context.next = 9;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated to use this operation. Use `useLogin` hook to authenticate.');
            sharedKernel.invariant(session.type === authentication.SessionType.WithProfile, 'You must have a profile to use this operation.');
            sharedKernel.invariant(((_args$handle$linkedTo = args.handle.linkedTo) === null || _args$handle$linkedTo === void 0 ? void 0 : _args$handle$linkedTo.nftTokenId) === session.profile.id, "You can't unlink handle that is not linked to current profile.");
            return _context.abrupt("return", unlinkHandle(configureRequest({
              kind: entities.TransactionKind.UNLINK_HANDLE,
              fullHandle: args.handle.fullHandle,
              profileId: session.profile.id,
              signless: session.profile.signless,
              sponsored: (_args$sponsored = args.sponsored) !== null && _args$sponsored !== void 0 ? _args$sponsored : true
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.SetFollowModuleDocument,
                variables: {
                  request: {
                    followModule: gql.resolveFollowModuleInput(request.policy)
                  }
                }
              });
            case 2:
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateSetFollowModuleTypedDataDocument,
                variables: {
                  request: {
                    followModule: gql.resolveFollowModuleInput(request.policy)
                  },
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            delegableExecution = new transactions.DelegableSigning(signedExecution, gateway, transactionQueue, presenter);
            paidExecution = new transactions.PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
            updateFollowPolicy = new profile.UpdateFollowPolicy(delegableExecution, paidExecution);
            _context.next = 9;
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", updateFollowPolicy(configureRequest({
              kind: entities.TransactionKind.UPDATE_FOLLOW_POLICY,
...
var UpdateProfileManagersGateway = /*#__PURE__*/function (_ref) {
  ...
  _createClass(UpdateProfileManagersGateway, [{
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return this.apolloClient.mutate({
                mutation: gql.CreateChangeProfileManagersTypedDataDocument,
                variables: {
                  request: {
                    ...
                    changeManagers: [].concat(_toConsumableArray((_request$add$map = (_request$add = request.add) === null || _request$add === void 0 ? void 0 : _request$add.map(function (address) {
                      return {
                        action: gql.ChangeProfileManagerActionType.Add,
                        address: address
                      };
                      ...
                      return {
                        action: gql.ChangeProfileManagerActionType.Remove,
                        address: address
                      };
    ...
    value: function createChangeDelegatedExecutorsConfigCallDetails(data) {
      var contract = blockchainBindings.digiHub(data.typedData.domain.verifyingContract);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            paidExecution = new transactions.PaidTransaction(activeWallet, gateway, presenter, transactionQueue);
            sponsoredExecution = new transactions.SignedOnChain(activeWallet, transactionGateway, gateway, onChainRelayer, transactionQueue, presenter);
            updateProfileManagers = new profile.UpdateProfileManagers(sponsoredExecution, paidExecution);
            _context.next = 8;
  ...
  return useDeferredTask( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(args) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            sharedKernel.invariant((session === null || session === void 0 ? void 0 : session.type) === authentication.SessionType.WithProfile, 'You must be authenticated with the Profile you intend update Profile Managers for. ' + 'Use `useLogin` hook to authenticate.');
            if ('approveSignless' in args) {
              sharedKernel.invariant(args.approveSignless === session.profile.signless, "The Signless Experience is already ".concat(args.approveSignless ? 'enabled' : 'disabled'));
            }
            return _context.abrupt("return", updateProfileManagers(configureRequest(_objectSpread2({
              kind: entities.TransactionKind.UPDATE_PROFILE_MANAGERS,
              sponsored: (_args$sponsored = args.sponsored) !== null && _args$sponsored !== void 0 ? _args$sponsored : true
            }, args))));
          case 3:
          case "end":
...
function useCanClaimHandle() {
  var _useSession = useSession(),
    session = _useSession.data;
  sharedKernel.invariant(session === null || session === void 0 ? void 0 : session.authenticated, 'You must be authenticated.');
  sharedKernel.invariant(session.type === authentication.SessionType.JustWallet, 'You must be authenticated with a WalletOnlySession');
  return useReadResult(gql.useClaimableProfiles(useDiGiApolloClient({
    fetchPolicy: 'network-only'
  })));
}
...
function useLastLoggedInProfile(args) {
  var _useReadResult = useReadResult(gql.useLastLoggedInProfile(useDiGiApolloClient({
      variables: useFragmentVariables({
        request: args
      })
    }))),
...
function useLazyProfilesManaged() {
  var _useProfilesManagedLa = gql.useProfilesManagedLazyQuery(useDiGiApolloClient({
      fetchPolicy: 'no-cache'
    })),
...
function useOwnedHandles(args) {
  return usePaginatedReadResult(gql.useOwnedHandles(useDiGiApolloClient({
    variables: args
  })));
}
...
function useProfilesManaged(args) {
  return usePaginatedReadResult(gql.useProfilesManaged(useDiGiApolloClient({
    variables: useFragmentVariables(args)
  })));
}
...
var mainnet = {
  ...
  nativeCurrency: sharedKernel.ether()
};
...
var polygon = {
  ...
  nativeCurrency: sharedKernel.matic()
};
...
var production = {
  ...
  chains: _defineProperty(_defineProperty({}, sharedKernel.ChainType.ETHEREUM, mainnet), sharedKernel.ChainType.POLYGON, polygon),
  timings: {
...
var development = {
  ...
  chains: _defineProperty(_defineProperty({}, sharedKernel.ChainType.ETHEREUM, goerli), sharedKernel.ChainType.POLYGON, mumbai),
  timings: {
    pollingInterval: 3000,
...
Object.defineProperty(exports, 'LogoutReason', {
  enumerable: true,
  get: function () { return authentication.LogoutReason; }
});
Object.defineProperty(exports, 'SessionType', {
  enumerable: true,
  get: function () { return authentication.SessionType; }
});
Object.defineProperty(exports, 'ClaimProfileWithHandleErrorReasonType', {
  enumerable: true,
  get: function () { return gql.ClaimProfileWithHandleErrorReasonType; }
});
Object.defineProperty(exports, 'CommentRankingFilterType', {
  enumerable: true,
  get: function () { return gql.CommentRankingFilterType; }
});
Object.defineProperty(exports, 'ComparisonOperatorConditionType', {
  enumerable: true,
  get: function () { return gql.ComparisonOperatorConditionType; }
});
Object.defineProperty(exports, 'CustomFiltersType', {
  enumerable: true,
  get: function () { return gql.CustomFiltersType; }
});
Object.defineProperty(exports, 'ExploreProfilesOrderByType', {
  enumerable: true,
  get: function () { return gql.ExploreProfilesOrderByType; }
});
Object.defineProperty(exports, 'ExplorePublicationType', {
  enumerable: true,
  get: function () { return gql.ExplorePublicationType; }
});
Object.defineProperty(exports, 'ExplorePublicationsOrderByType', {
  enumerable: true,
  get: function () { return gql.ExplorePublicationsOrderByType; }
});
Object.defineProperty(exports, 'FeedEventItemType', {
  enumerable: true,
  get: function () { return gql.FeedEventItemType; }
});
Object.defineProperty(exports, 'FollowModuleType', {
  enumerable: true,
  get: function () { return gql.FollowModuleType; }
});
Object.defineProperty(exports, 'HiddenCommentsType', {
  enumerable: true,
  get: function () { return gql.HiddenCommentsType; }
});
Object.defineProperty(exports, 'LimitType', {
  enumerable: true,
  get: function () { return gql.LimitType; }
});
Object.defineProperty(exports, 'MarketplaceMetadataAttributeDisplayType', {
  enumerable: true,
  get: function () { return gql.MarketplaceMetadataAttributeDisplayType; }
});
Object.defineProperty(exports, 'NftContractType', {
  enumerable: true,
  get: function () { return gql.NftContractType; }
});
Object.defineProperty(exports, 'NotificationType', {
  enumerable: true,
  get: function () { return gql.NotificationType; }
});
Object.defineProperty(exports, 'OpenActionCategoryType', {
  enumerable: true,
  get: function () { return gql.OpenActionCategoryType; }
});
Object.defineProperty(exports, 'OpenActionModuleType', {
  enumerable: true,
  get: function () { return gql.OpenActionModuleType; }
});
Object.defineProperty(exports, 'ProfileActionHistoryType', {
  enumerable: true,
  get: function () { return gql.ProfileActionHistoryType; }
});
Object.defineProperty(exports, 'ProfileInterestTypes', {
  enumerable: true,
  get: function () { return gql.ProfileInterestTypes; }
});
Object.defineProperty(exports, 'PublicationContentWarningType', {
  enumerable: true,
  get: function () { return gql.PublicationContentWarningType; }
});
Object.defineProperty(exports, 'PublicationMetadataLicenseType', {
  enumerable: true,
  get: function () { return gql.PublicationMetadataLicenseType; }
});
Object.defineProperty(exports, 'PublicationMetadataMainFocusType', {
  enumerable: true,
  get: function () { return gql.PublicationMetadataMainFocusType; }
});
Object.defineProperty(exports, 'PublicationMetadataTransactionType', {
  enumerable: true,
  get: function () { return gql.PublicationMetadataTransactionType; }
});
Object.defineProperty(exports, 'PublicationReactionType', {
  enumerable: true,
  get: function () { return gql.PublicationReactionType; }
});
Object.defineProperty(exports, 'PublicationType', {
  enumerable: true,
  get: function () { return gql.PublicationType; }
});
Object.defineProperty(exports, 'SearchPublicationType', {
  enumerable: true,
  get: function () { return gql.SearchPublicationType; }
});
Object.defineProperty(exports, 'SupportedFiatType', {
  enumerable: true,
  get: function () { return gql.SupportedFiatType; }
});
Object.defineProperty(exports, 'TriStateValue', {
  enumerable: true,
  get: function () { return gql.TriStateValue; }
});
Object.defineProperty(exports, 'UnspecifiedError', {
  enumerable: true,
  get: function () { return gql.UnspecifiedError; }
});
Object.defineProperty(exports, 'erc20Amount', {
  enumerable: true,
  get: function () { return gql.erc20Amount; }
});
Object.defineProperty(exports, 'fiatAmount', {
  enumerable: true,
  get: function () { return gql.fiatAmount; }
});
Object.defineProperty(exports, 'findCollectModuleSettings', {
  enumerable: true,
  get: function () { return gql.findCollectModuleSettings; }
});
Object.defineProperty(exports, 'isCollectModuleSettings', {
  enumerable: true,
  get: function () { return gql.isCollectModuleSettings; }
});
Object.defineProperty(exports, 'isCommentPublication', {
  enumerable: true,
  get: function () { return gql.isCommentPublication; }
});
Object.defineProperty(exports, 'isMirrorPublication', {
  enumerable: true,
  get: function () { return gql.isMirrorPublication; }
});
Object.defineProperty(exports, 'isPostPublication', {
  enumerable: true,
  get: function () { return gql.isPostPublication; }
});
Object.defineProperty(exports, 'isPrimaryPublication', {
  enumerable: true,
  get: function () { return gql.isPrimaryPublication; }
});
Object.defineProperty(exports, 'isQuotePublication', {
  enumerable: true,
  get: function () { return gql.isQuotePublication; }
});
Object.defineProperty(exports, 'resolveFollowPolicy', {
  enumerable: true,
  get: function () { return gql.resolveFollowPolicy; }
});
Object.defineProperty(exports, 'resolveReferencePolicy', {
  enumerable: true,
  get: function () { return gql.resolveReferencePolicy; }
});
Object.defineProperty(exports, 'InsufficientGasError', {
  enumerable: true,
  get: function () { return entities.InsufficientGasError; }
});
Object.defineProperty(exports, 'PendingSigningRequestError', {
  enumerable: true,
  get: function () { return entities.PendingSigningRequestError; }
});
Object.defineProperty(exports, 'ProfileReportReason', {
  enumerable: true,
  get: function () { return entities.ProfileReportReason; }
});
Object.defineProperty(exports, 'PublicationReportReason', {
  enumerable: true,
  get: function () { return entities.PublicationReportReason; }
});
Object.defineProperty(exports, 'TransactionError', {
  enumerable: true,
  get: function () { return entities.TransactionError; }
});
Object.defineProperty(exports, 'UserRejectedError', {
  enumerable: true,
  get: function () { return entities.UserRejectedError; }
});
Object.defineProperty(exports, 'WalletConnectionError', {
  enumerable: true,
  get: function () { return entities.WalletConnectionError; }
});
Object.defineProperty(exports, 'BroadcastingError', {
  enumerable: true,
  get: function () { return transactions.BroadcastingError; }
});
Object.defineProperty(exports, 'BroadcastingErrorReason', {
  enumerable: true,
  get: function () { return transactions.BroadcastingErrorReason; }
});
Object.defineProperty(exports, 'TokenAllowanceLimit', {
  enumerable: true,
  get: function () { return transactions.TokenAllowanceLimit; }
});
Object.defineProperty(exports, 'InsufficientAllowanceError', {
  enumerable: true,
  get: function () { return wallets.InsufficientAllowanceError; }
});
Object.defineProperty(exports, 'InsufficientFundsError', {
  enumerable: true,
  get: function () { return wallets.InsufficientFundsError; }
});
Object.defineProperty(exports, 'Amount', {
  enumerable: true,
  get: function () { return sharedKernel.Amount; }
});
Object.defineProperty(exports, 'ChainType', {
  enumerable: true,
  get: function () { return sharedKernel.ChainType; }
});
Object.defineProperty(exports, 'InvariantError', {
  enumerable: true,
  get: function () { return sharedKernel.InvariantError; }
});
Object.defineProperty(exports, 'erc20', {
  enumerable: true,
  get: function () { return sharedKernel.erc20; }
});
Object.defineProperty(exports, 'ether', {
  enumerable: true,
  get: function () { return sharedKernel.ether; }
});
Object.defineProperty(exports, 'fiat', {
  enumerable: true,
  get: function () { return sharedKernel.fiat; }
});
Object.defineProperty(exports, 'matic', {
  enumerable: true,
  get: function () { return sharedKernel.matic; }
});
Object.defineProperty(exports, 'FollowPolicyType', {
  enumerable: true,
  get: function () { return profile.FollowPolicyType; }
});
Object.defineProperty(exports, 'OpenActionType', {
  enumerable: true,
  get: function () { return publications.OpenActionType; }
});
Object.defineProperty(exports, 'ReferencePolicyType', {
  enumerable: true,
  get: function () { return publications.ReferencePolicyType; }
});
...
exports.PrematureFollowError = PrematureFollowError;
exports.appId = appId;
exports.data = data;
exports.development = development;
exports.goerli = goerli;
exports.hasReacted = hasReacted;
exports.mainnet = mainnet;
exports.mumbai = mumbai;
exports.polygon = polygon;
exports.production = production;
exports.profileId = profileId;
exports.publicationId = publicationId;
...
exports.useApproveModule = useApproveModule;
exports.useBlockProfiles = useBlockProfiles;
exports.useBlockedProfiles = useBlockedProfiles;
exports.useBookmarkToggle = useBookmarkToggle;
exports.useBookmarks = useBookmarks;
exports.useCanClaimHandle = useCanClaimHandle;
exports.useClaimHandle = useClaimHandle;
exports.useCreateComment = useCreateComment;
exports.useCreateMirror = useCreateMirror;
exports.useCreatePost = useCreatePost;
exports.useCreateProfile = useCreateProfile;
exports.useCreateQuote = useCreateQuote;
exports.useCurrencies = useCurrencies;
exports.useDeferredTask = useDeferredTask;
exports.useDismissRecommendedProfiles = useDismissRecommendedProfiles;
...
exports.useFeedHighlights = useFeedHighlights;
exports.useFollow = useFollow;
exports.useHideCommentToggle = useHideCommentToggle;
exports.useHidePublication = useHidePublication;
exports.useInviteWallets = useInviteWallets;
exports.useInvitedProfiles = useInvitedProfiles;
exports.useLastLoggedInProfile = useLastLoggedInProfile;
exports.useLazyModuleMetadata = useLazyModuleMetadata;
exports.useLazyProfile = useLazyProfile;
exports.useLazyProfiles = useLazyProfiles;
exports.useLazyProfilesManaged = useLazyProfilesManaged;
exports.useLazyPublication = useLazyPublication;
exports.useLazyPublications = useLazyPublications;
exports.useLazyWasWalletInvited = useLazyWasWalletInvited;
exports.useLinkHandle = useLinkHandle;
exports.useLogin = useLogin;
exports.useLogout = useLogout;
exports.useModuleMetadata = useModuleMetadata;
exports.useMutualFollowers = useMutualFollowers;
exports.useNotInterestedToggle = useNotInterestedToggle;
exports.useNotifications = useNotifications;
exports.useOpenAction = useOpenAction;
exports.useOwnedHandles = useOwnedHandles;
exports.useProfile = useProfile;
exports.useProfileActionHistory = useProfileActionHistory;
exports.useProfileFollowers = useProfileFollowers;
exports.useProfileFollowing = useProfileFollowing;
exports.useProfileManagers = useProfileManagers;
exports.useProfiles = useProfiles;
exports.useProfilesManaged = useProfilesManaged;
exports.usePublication = usePublication;
exports.usePublications = usePublications;
exports.useReactionToggle = useReactionToggle;
exports.useRecommendedProfiles = useRecommendedProfiles;
exports.useReportProfile = useReportProfile;
exports.useReportPublication = useReportPublication;
exports.useResolveAddress = useResolveAddress;
exports.useRevenueFromFollow = useRevenueFromFollow;
exports.useRevenueFromPublication = useRevenueFromPublication;
exports.useRevenueFromPublications = useRevenueFromPublications;
exports.useSearchProfiles = useSearchProfiles;
exports.useSearchPublications = useSearchPublications;
exports.useSession = useSession;
exports.useSetProfileMetadata = useSetProfileMetadata;
exports.useSharedDependencies = useSharedDependencies;
exports.useStorage = useStorage;
exports.useUnblockProfiles = useUnblockProfiles;
exports.useUnfollow = useUnfollow;
exports.useUnlinkHandle = useUnlinkHandle;
exports.useUpdateFollowPolicy = useUpdateFollowPolicy;
exports.useUpdateProfileManagers = useUpdateProfileManagers;
exports.useUpgradeCredentials = useUpgradeCredentials;
exports.useValidateHandle = useValidateHandle;
exports.useWasWalletInvited = useWasWalletInvited;
exports.useWhoActedOnPublication = useWhoActedOnPublication;
exports.useWhoReactedToPublication = useWhoReactedToPublication;
