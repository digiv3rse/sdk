import { ChainType, URL } from '@digiv3rse/shared-kernel';
...
export const production: EnvironmentConfig = {
  name: 'production',
  backend: 'https://api-v2.digi.dev' as URL,
  chains: {
  ...
  handleResolver: (localName) => `digi/${localName}`,
};
...
export const development: EnvironmentConfig = {
  name: 'development',
  backend: 'https://api-v2-mumbai-live.digi.dev' as URL,
  chains: {
...
export const staging: EnvironmentConfig = {
  name: 'staging',
  backend: 'https://api-mumbai.digi-v2.crtlkey.com' as URL,
  chains: {
    [ChainType.ETHEREUM]: goerli,
    [ChainType.POLYGON]: mumbai,
  },
