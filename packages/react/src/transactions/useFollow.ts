...
import { Profile, TriStateValue, resolveFollowPolicy } from '@digiv3rse/api-bindings';
import {
...
import { FollowPolicyType, FollowRequest } from '@digiv3rse/domain/use-cases/profile';
