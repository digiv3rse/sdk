import { mockPostFragment } from '@digiv3rse/api-bindings/mocks';
import {
...
import { mockCreatePostRequest, mockTransactionData } from '@digiv3rse/domain/mocks';
...
import { failure, Result, success } from '@digiv3rse/shared-kernel';
