import { RelayError, RelayErrorReasonType, RelaySuccess } from '@digiv3rse/api-bindings';
import {
...
import { ISignedProtocolCall, MetaTransaction } from '@digiv3rse/domain/entities';
import {
  BroadcastingError,
  BroadcastingErrorReason,
  ProtocolTransactionRequest,
} from '@digiv3rse/domain/use-cases/transactions';
import { ChainType, ILogger } from '@digiv3rse/shared-kernel';
...
function setupRelayer({
  ...
  const apollo = mockDiGiApolloClient([
    mockBroadcastOnchainResponse({
