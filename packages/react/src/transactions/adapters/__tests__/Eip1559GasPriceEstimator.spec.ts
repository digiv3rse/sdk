import { mockFeeHistoryResult } from '@digiv3rse/blockchain-bindings/mocks';
import { Amount, CryptoNativeAmount, CryptoNativeAsset } from '@digiv3rse/shared-kernel';
import { mockEtherGweiAmount, mockMaticGweiAmount } from '@digiv3rse/shared-kernel/mocks';
