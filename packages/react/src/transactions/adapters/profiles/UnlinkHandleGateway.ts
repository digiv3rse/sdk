...
import { digiTokenHandleRegistry } from '@digiv3rse/blockchain-bindings';
import { NativeTransaction, Nonce } from '@digiv3rse/domain/entities';
import { UnlinkHandleRequest } from '@digiv3rse/domain/use-cases/profile';
import {
  BroadcastingError,
  IDelegatedTransactionGateway,
  ISignedOnChainGateway,
} from '@digiv3rse/domain/use-cases/transactions';
import { ChainType, Data, PromiseResult, success } from '@digiv3rse/shared-kernel';
import { v4 } from 'uuid';
    ...
    ISignedOnChainGateway<UnlinkHandleRequest>
{
  ...
  private createUnlinkCallData(
    ...
    const contract = digiTokenHandleRegistry(result.typedData.domain.verifyingContract);
