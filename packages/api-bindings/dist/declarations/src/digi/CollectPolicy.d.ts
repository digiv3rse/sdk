import { CollectPolicyType } from '@digiv3rse/domain/use-cases/publications';
import { Erc20Amount, EthereumAddress } from '@digiv3rse/shared-kernel';
export declare enum CollectState {
...
export type FeeCollectPolicy = {
    ...
    state: CollectState.CAN_BE_COLLECTED | CollectState.NOT_A_FOLLOWER | CollectState.COLLECT_LIMIT_REACHED | CollectState.COLLECT_TIME_EXPIRED;
    amount: Erc20Amount;
    referralFee: number;
...
export type LimitedFeeCollectPolicy = {
    type: CollectPolicyType.CHARGE;
    state: CollectState.CAN_BE_COLLECTED | CollectState.NOT_A_FOLLOWER | CollectState.COLLECT_LIMIT_REACHED;
    amount: Erc20Amount;
    referralFee: number;
    followerOnly: boolean;
    collectLimit: number;
...
export type TimedFeeCollectPolicy = {
    type: CollectPolicyType.CHARGE;
    state: CollectState.CAN_BE_COLLECTED | CollectState.NOT_A_FOLLOWER | CollectState.COLLECT_TIME_EXPIRED;
    amount: Erc20Amount;
    referralFee: number;
    followerOnly: boolean;
    endTimestamp: string;
...
export type CollectPolicy = FeeCollectPolicy | NoFeeCollectPolicy | LimitedFeeCollectPolicy | TimedFeeCollectPolicy | LimitedTimedFeeCollectPolicy | MultirecipientFeeCollectPolicy | VaultFeeCollectPolicy | AaveFeeCollectPolicy | NoCollectPolicy;
