import { ReferencePolicyType } from '@digiv3rse/domain/use-cases/publications';
...
export type ReferencePolicy = FollowersOnlyPolicy | UnknownPolicy | DegreesOfSeparationPolicy | AnyonePolicy;
