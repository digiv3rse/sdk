...
export declare const FragmentSnapshotProposal: Apollo.DocumentNode;
export declare const FragmentSnapshotVote: Apollo.DocumentNode;
export declare const FragmentSnapshotVotePower: Apollo.DocumentNode;
export declare const GetSnapshotProposalDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useGetSnapshotProposal(baseOptions: Apollo.QueryHookOptions<GetSnapshotProposalData, GetSnapshotProposalVariables>): Apollo.QueryResult<GetSnapshotProposalData, Exact<{
    spaceId: string;
    proposalId: string;
    voterAddress: string;
    includeVotes: boolean;
}>>;
export declare function useGetSnapshotProposalLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSnapshotProposalData, GetSnapshotProposalVariables>): Apollo.LazyQueryResultTuple<GetSnapshotProposalData, Exact<{
    spaceId: string;
    proposalId: string;
    voterAddress: string;
    includeVotes: boolean;
...
export type GetSnapshotProposalLazyQueryHookResult = ReturnType<typeof useGetSnapshotProposalLazyQuery>;
export type GetSnapshotProposalQueryResult = Apollo.QueryResult<GetSnapshotProposalData, GetSnapshotProposalVariables>;
