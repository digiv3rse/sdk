...
/**
 * Convert an Amount returned from the DiGi API to an Erc20Amount
 *
 * @param from - Amount returned from the DiGi API
...
/**
 * Convert a FiatAmount returned from the DiGi API to a FiatAmount
 *
 * @param from - FiatAmount returned from the DiGi API
