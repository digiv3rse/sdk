...
import { switchChain, getPublicClient, getWalletClient } from 'wagmi/actions';
...
function clientToProvider(_ref) {
  ...
  if (transport.type === 'fallback') {
    return new FallbackProvider(transport.transports.map(function (_ref2) {
      var value = _ref2.value;
      return new JsonRpcProvider(value === null || value === void 0 ? void 0 : value.url, network);
    }));
  }
...
function clientToSigner(_ref3) {
  ...
  var provider = new Web3Provider(transport, 'any');
