...
export type ActOnOpenActionDiGiManagerRequest = {
    readonly actOn: ActOnOpenActionDiGiManagerInput;
...
export type FollowDiGiManager = {
    readonly followModule?: InputMaybe<FollowDiGiManagerModuleRedeemInput>;
    readonly profileId: Scalars['ProfileId'];
};
...
export type FollowDiGiManagerRequest = {
    readonly follow: ReadonlyArray<FollowDiGiManager>;
};
...
export type DiGiProfileManagerRelayError = {
    readonly __typename: 'DiGiProfileManagerRelayError';
    readonly reason: DiGiProfileManagerRelayErrorReasonType;
};
export declare enum DiGiProfileManagerRelayErrorReasonType {
...
export declare enum DiGiProtocolVersion {
    V1 = "V1",
    V2 = "V2"
}
export declare enum DiGiTransactionFailureType {
    MetadataError = "METADATA_ERROR",
    Reverted = "REVERTED"
}
export type DiGiTransactionResult = {
    readonly __typename: 'DiGiTransactionResult';
    readonly extraInfo?: Maybe<Scalars['String']>;
    readonly reason?: Maybe<DiGiTransactionFailureType>;
    readonly status: DiGiTransactionStatusType;
...
export declare enum DiGiTransactionStatusType {
    Complete = "COMPLETE",
    Failed = "FAILED",
...
export type Mutation = {
    ...
    readonly actOnOpenAction: DiGiProfileManagerRelayResult;
    ...
    readonly block: DiGiProfileManagerRelayResult;
    ...
    readonly commentOnchain: DiGiProfileManagerRelayResult;
    ...
    readonly follow: DiGiProfileManagerRelayResult;
    ...
    readonly legacyCollect: DiGiProfileManagerRelayResult;
    readonly linkHandleToProfile: DiGiProfileManagerRelayResult;
    readonly mirrorOnMomoka: RelayMomokaResult;
    readonly mirrorOnchain: DiGiProfileManagerRelayResult;
    readonly nftOwnershipChallenge: NftOwnershipChallengeResult;
    readonly postOnMomoka: RelayMomokaResult;
    readonly postOnchain: DiGiProfileManagerRelayResult;
    readonly quoteOnMomoka: RelayMomokaResult;
    readonly quoteOnchain: DiGiProfileManagerRelayResult;
    ...
    readonly setFollowModule: DiGiProfileManagerRelayResult;
    readonly setProfileMetadata: DiGiProfileManagerRelayResult;
    readonly unblock: DiGiProfileManagerRelayResult;
    readonly undoPublicationNotInterested?: Maybe<Scalars['Void']>;
    readonly unfollow: DiGiProfileManagerRelayResult;
    readonly unlinkHandleFromProfile: DiGiProfileManagerRelayResult;
...
export type ProfilesManagedResult = {
    ...
    readonly address: Scalars['EvmAddress'];
    readonly isDiGiManager: Scalars['Boolean'];
};
...
export type Query = {
    ...
    readonly digiAPIOwnedEOAs: ReadonlyArray<Scalars['EvmAddress']>;
    readonly digiProtocolVersion: DiGiProtocolVersion;
    readonly digiTransactionStatus?: Maybe<DiGiTransactionResult>;
...
export type UserSigNonces = {
    ...
    readonly digiHubOnchainSigNonce: Scalars['Nonce'];
    readonly digiPublicActProxyOnchainSigNonce: Scalars['Nonce'];
    readonly digiTokenHandleRegistryOnchainSigNonce: Scalars['Nonce'];
};
