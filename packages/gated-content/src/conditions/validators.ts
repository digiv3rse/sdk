...
import { ProfileId, PublicationId } from '@digiv3rse/metadata';
import { EvmAddress, IEquatableError, TwoAtLeastArray } from '@digiv3rse/shared-kernel';
...
function isValidDiGiId(id: string): boolean {
