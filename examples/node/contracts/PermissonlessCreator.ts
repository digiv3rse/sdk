...
export interface PermissonlessCreatorInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'DIGI_HANDLES', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'DIGI_HANDLES', data: BytesLike): Result;
...
export interface PermissonlessCreator extends BaseContract {
  ...
  functions: {
    DIGI_HANDLES(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    DIGI_HANDLES(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    DIGI_HANDLES(overrides?: CallOverrides): Promise<PopulatedTransaction>;
